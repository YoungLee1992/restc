! function (e) {
  ...
  function e(r, n) {
    ...
    this.options = n = n ? Ri(n) : {}, Ri(rl, n, !1), d(n);
    var i = n.value;
    ...
    l.wrapper.CodeMirror = this, u(this), s(this), n.lineWrapping && (this.display.wrapper.className += " CodeMirror-wrap"), n.autofocus && !Oo && l.input.focus(), m(this), this.state = {
      keyMaps: [],
      overlays: [],
      modeGen: 0,
      overwrite: !1,
    ...
    var a = this;
    xo && Co < 11 && setTimeout(function () {
      a.display.input.reset(!0)
    }, 20), Vt(this), Zi(), xt(this), this.curOp.forceUpdate = !0, Zn(this, i), n.autofocus && !Oo || a.hasFocus() ? setTimeout(Bi(mr, this), 20) : yr(this);
    for (var c in nl) nl.hasOwnProperty(c) && nl[c](this, n[c], il);
    C(this), n.finishInit && n.finishInit(this);
    for (var h = 0; h < al.length; ++h) al[h](this);
    St(this), So && n.lineWrapping && "optimizelegibility" == getComputedStyle(l.lineDiv).textRendering && (l.lineDiv.style.textRendering = "auto")
  }
  ...
  function n(e) {
    ...
    }), e.doc.frontier = e.doc.first, Re(e, 100), e.state.modeGen++, e.curOp && It(e)
  }

  function i(e) {
    e.options.lineWrapping ? (es(e.display.wrapper, "CodeMirror-wrap"), e.display.sizer.style.minWidth = "", e.display.sizerWidth = null) : (Jl(e.display.wrapper, "CodeMirror-wrap"), f(e)), l(e), It(e), at(e), setTimeout(function () {
      y(e)
    }, 100)
  }
  ...
  function o(e) {
    var t = bt(e.display),
      ...
      n = r && Math.max(5, e.display.scroller.clientWidth / wt(e.display) - 3);
    return function (i) {
  ...
  function f(e) {
    var t = e.display,
      r = e.doc;
    t.maxLine = Qn(r, r.first), t.maxLineLength = h(t.maxLine), t.maxLineChanged = !0, r.iter(function (e) {
      var r = h(e);
  ...
  function g(e, t, r) {
    ...
    e(n), e(i), Dl(n, "scroll", function () {
      n.clientHeight && t(n.scrollTop, "vertical")
    }), Dl(i, "scroll", function () {
      i.clientWidth && t(i.scrollLeft, "horizontal")
    }), this.checkedZeroWidth = !1, xo && Co < 8 && (this.horiz.style.minHeight = this.vert.style.minWidth = "18px")
  }

  function v() {}

  function m(t) {
    t.display.scrollbars && (t.display.scrollbars.clear(), t.display.scrollbars.addClass && Jl(t.display.wrapper, t.display.scrollbars.addClass)), t.display.scrollbars = new e.scrollbarModel[t.options.scrollbarStyle](function (e) {
      t.display.wrapper.insertBefore(e, t.display.scrollbarFiller), Dl(e, "mousedown", function () {
        t.state.focused && setTimeout(function () {
          t.display.input.focus()
        }, 0)
      }), e.setAttribute("cm-not-content", "true")
    }, function (e, r) {
      "horizontal" == r ? or(t, e) : ir(t, e)
  ...
  function y(e, t) {
    ...
    b(e, t);
    for (var i = 0; i < 4 && r != e.display.barWidth || n != e.display.barHeight; i++) r != e.display.barWidth && e.options.lineWrapping && O(e), b(e, p(e)), r = e.display.barWidth, n = e.display.barHeight
  }
  ...
  function w(e, t, r) {
    ...
    if (r && r.ensure) {
      var s = r.ensure.from.line,
        a = r.ensure.to.line;
      s < o ? (o = s, l = ni(t, ii(Qn(t, s)) + e.wrapper.clientHeight)) : Math.min(a, t.lastLine()) >= l && (o = ni(t, ii(Qn(t, a)) - e.wrapper.clientHeight), l = a)
    }
    return {
      from: o,
      to: Math.max(l, o + 1)
  ...
  function M(e, t) {
    ...
    if (!t.force && t.visible.from >= r.viewFrom && t.visible.to <= r.viewTo && (null == r.updateLineNumbers || r.updateLineNumbers >= r.viewTo) && r.renderedView == r.view && 0 == Ut(e)) return !1;
    C(e) && (Ft(e), t.dims = H(e));
    ...
    r.viewFrom < o && o - r.viewFrom < 20 && (o = Math.max(n.first, r.viewFrom)), r.viewTo > l && r.viewTo - l < 20 && (l = Math.min(i, r.viewTo)), Ro && (o = xn(e.doc, o), l = Cn(e.doc, l));
    var s = o != r.viewFrom || l != r.viewTo || r.lastWrapHeight != t.wrapperHeight || r.lastWrapWidth != t.wrapperWidth;
    Gt(e, o, l), r.viewOffset = ii(Qn(e.doc, r.viewFrom)), e.display.mover.style.top = r.viewOffset + "px";
    var a = Ut(e);
    if (!s && 0 == a && !t.force && r.renderedView == r.view && (null == r.updateLineNumbers || r.updateLineNumbers >= r.viewTo)) return !1;
    var u = Yi();
    return a > 4 && (r.lineDiv.style.display = "none"), P(e, r.updateLineNumbers, t.dims), a > 4 && (r.lineDiv.style.display = ""), r.renderedView = r.view, u && Yi() != u && u.offsetHeight && u.focus(), ji(r.cursorDiv), ji(r.selectionDiv), r.gutters.style.height = r.sizer.style.minHeight = 0, s && (r.lastWrapHeight = t.wrapperHeight, r.lastWrapWidth = t.wrapperWidth, Re(e, 400)), r.updateLineNumbers = null, !0
  }
  ...
  function W(e, t) {
    ...
    if (M(e, r)) {
      O(e), N(e, r);
      var n = p(e);
      Pe(e), y(e, n), A(e, n), r.finish()
    }
  }

  function A(e, t) {
    e.display.sizer.style.minHeight = t.docHeight + "px", e.display.heightForcer.style.top = t.docHeight + "px", e.display.gutters.style.height = t.docHeight + e.display.barHeight + Xe(e) + "px"
  }
  ...
  function O(e) {
    for (var t = e.display, r = t.lineDiv.offsetTop, n = 0; n < t.view.length; n++) {
      ...
      if (!o.hidden) {
        ...
        if (i < 2 && (i = bt(t)), (a > .001 || a < -.001) && (ti(o.line, i), D(o.line), o.rest))
  ...
  function P(e, t, r) {
    function n(t) {
      var r = t.nextSibling;
      return So && Do && e.display.currentWheelTarget == t ? t.style.display = "none" : t.parentNode.removeChild(t), r
    }
    for (var i = e.display, o = e.options.lineNumbers, l = i.lineDiv, s = l.firstChild, a = i.view, u = i.viewFrom, c = 0; c < a.length; c++) {
      ...
      if (h.hidden);
        ...
        for (; s != h.node;) s = n(s);
        var f = o && null != t && t <= u && h.lineNumber;
        h.changes && (Pi(h.changes, "gutter") > -1 && (f = !1), E(e, h, u, r)), f && (ji(h.lineNumber), h.lineNumber.appendChild(document.createTextNode(S(e.options, u)))), s = h.node.nextSibling
      } else {
        var d = V(e, h, u, r);
        l.insertBefore(d, s)
      }
  ...
  function I(e) {
    return e.node == e.text && (e.node = Ki("div", null, null, "position: relative"), e.text.parentNode && e.text.parentNode.replaceChild(e.node, e.text), e.node.appendChild(e.text), xo && Co < 8 && (e.node.style.zIndex = 2)), e.node
  }
  ...
  function F(e, t) {
    ...
    return r && r.line == t.line ? (e.display.externalMeasured = null, t.measure = r.measure, r.built) : Rn(e, t)
  }
  ...
  function G(e, t, r, n) {
    ...
    if (e.options.lineNumbers || o) {
      var i = I(t),
        l = t.gutter = Ki("div", null, "CodeMirror-gutter-wrapper", "left: " + (e.options.fixedGutter ? n.fixedPos : -n.gutterTotalWidth) + "px");
      if (e.display.input.setUneditable(l), i.insertBefore(l, t.text), t.line.gutterClass && (l.className += " " + t.line.gutterClass), !e.options.lineNumbers || o && o["CodeMirror-linenumbers"] || (t.lineNumber = l.appendChild(Ki("div", S(e.options, r), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + n.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))), o)
        for (var s = 0; s < e.options.gutters.length; ++s) {
          var a = e.options.gutters[s],
            u = o.hasOwnProperty(a) && o[a];
          u && l.appendChild(Ki("div", [u], "CodeMirror-gutter-elt", "left: " + n.gutterLeft[a] + "px; width: " + n.gutterWidth[a] + "px"))
        }
    }
  }
  ...
  function j(e, t, r, n, i) {
    if (t.widgets)
      for (var o = I(r), l = 0, s = t.widgets; l < s.length; ++l) {
        var a = s[l],
          u = Ki("div", [a.node], "CodeMirror-linewidget");
        a.handleMouseEvents || u.setAttribute("cm-ignore-events", "true"), X(a, u, r, n), e.display.input.setUneditable(u), i && a.above ? o.insertBefore(u, r.gutter || r.text) : o.appendChild(u), Ti(a, "redraw")
      }
  }
  ...
  function Z(e, t, r, n, i) {
    ...
    if (l && n.ranges.length > 1)
      if (Uo && Uo.text.join("\n") == t) {
        if (n.ranges.length % Uo.text.length == 0) {
          a = [];
          for (var u = 0; u < Uo.text.length; u++) a.push(o.splitLines(Uo.text[u]))
        }
      } else s.length == n.ranges.length && (a = Ei(s, function (e) {
        return [e]
      }));
    for (var u = n.ranges.length - 1; u >= 0; u--) {
      var c = n.ranges[u],
        h = c.from(),
        f = c.to();
      c.empty() && (r && r > 0 ? h = Bo(h.line, h.ch - r) : e.state.overwrite && !l ? f = Bo(f.line, Math.min(Qn(o, f.line).text.length, f.ch + Hi(s).length)) : Uo && Uo.lineWise && Uo.text.join("\n") == t && (h = f = Bo(h.line, 0)));
      ...
      kr(e.doc, p), Ti(e, "inputRead", e, p)
    }
    t && !l && J(e, t), Fr(e), e.curOp.updateInput = d, e.curOp.typing = !0, e.state.pasteIncoming = e.state.cutIncoming = !1
  }

  function Q(e, t) {
    var r = e.clipboardData && e.clipboardData.getData("Text");
    if (r) return e.preventDefault(), t.isReadOnly() || t.options.disableInput || At(t, function () {
      Z(t, r, 0, null, "paste")
    }), !0
  }
    ...
    if (e.options.electricChars && e.options.smartIndent)
      for (var r = e.doc.sel, n = r.ranges.length - 1; n >= 0; n--) {
        ...
        if (!(i.head.ch > 100 || n && r.ranges[n - 1].head.line == i.head.line)) {
          ...
          } else o.electricInput && o.electricInput.test(Qn(e.doc, i.head.line).text.slice(0, i.head.ch)) && (l = Br(e, i.head.line, "smart"));
          l && Ti(e, "electricInput", e, i.head.line)
        }
      }
  }
  ...
  function ne() {
    var e = Ki("textarea", null, null, "position: absolute; bottom: -1em; padding: 0; width: 1px; height: 1em; outline: none"),
      t = Ki("div", [e], null, "overflow: hidden; position: relative; width: 3px; height: 0px;");
    return So ? e.style.width = "1000px" : e.setAttribute("wrap", "off"), Ao && (e.style.border = "1px solid black"), te(e), t
  }
  ...
  function se(e, t, r) {
    ...
    if (t == e.display.lineDiv) {
      if (n = e.display.lineDiv.childNodes[r], !n) return le(e.clipPos(Bo(e.display.viewTo - 1)), !0);
      t = null, r = 0
    } else
  ...
  function ae(e, t, r) {
    function n(t, r, n) {
      for (var i = -1; i < (c ? c.length : 0); i++)
        for (var o = i < 0 ? u.map : c[i], l = 0; l < o.length; l += 3) {
          var s = o[l + 2];
          if (s == t || s == r) {
            var a = ri(i < 0 ? e.line : e.rest[i]),
              h = o[l] + n;
            return (n < 0 || s != t) && (h = o[l + (n ? 1 : 0)]), Bo(a, h)
          }
        }
    }
    ...
    if (t == i && (o = !0, t = i.childNodes[r], r = 0, !t)) {
      var l = e.rest ? Hi(e.rest) : e.line;
      return le(Bo(ri(l), l.text.length), o)
    }
    ...
    for (var f = a.nextSibling, d = s ? s.nodeValue.length - r : 0; f; f = f.nextSibling) {
      if (h = n(f, f.firstChild, 0)) return le(Bo(h.line, h.ch - d), o);
      d += f.textContent.length
    }
    for (var p = a.previousSibling, d = r; p; p = p.previousSibling) {
      if (h = n(p, p.firstChild, -1)) return le(Bo(h.line, h.ch + d), o);
  ...
  function ue(e, t, r, n, i) {
    ...
    function l(t) {
      if (1 == t.nodeType) {
        ...
        if (h) {
          var f = e.findMarks(Bo(n, 0), Bo(i + 1, 0), o(+h));
          return void(f.length && (c = f[0].find()) && (s += Jn(e.doc, c.from, c.to).join(u)))
        }
  ...
  function fe(e, t) {
    ...
    for (var n = 1; n < e.length; n++) {
      ...
      if (Go(o.to(), i.from()) >= 0) {
        ...
        n <= t && --t, e.splice(--n, 2, new he(a ? s : l, a ? l : s))
      }
    }
    return new ce(e, t)
  }
  ...
  function ge(e, t) {
    ...
    return t.line > r ? Bo(r, Qn(e, r).text.length) : ve(t, Qn(e, t.line).text.length)
  }

  function ve(e, t) {
    var r = e.ch;
    return null == r || r > t ? Bo(e.line, t) : r < 0 ? Bo(e.line, 0) : e
  }
  ...
  function be(e, t, r, n) {
    if (e.cm && e.cm.display.shift || e.extend) {
      ...
      if (n) {
        var o = Go(r, i) < 0;
        o != Go(n, i) < 0 ? (i = r, r = n) : o != Go(r, n) < 0 && (r = n)
      }
      return new he(i, r)
    }
    return new he(n || r, r)
  ...
  function Le(e, t, r) {
    ...
    return El(e, "beforeSelectionChange", e, n), e.cm && El(e.cm, "beforeSelectionChange", e.cm, n), n.ranges != t.ranges ? fe(n.ranges, n.ranges.length - 1) : t
  }
  ...
  function ke(e, t, r) {
    Me(e, t, r), fi(e, e.sel, e.cm ? e.cm.curOp.id : NaN, r)
  }

  function Me(e, t, r) {
    (Wi(e, "beforeSelectionChange") || e.cm && Wi(e.cm, "beforeSelectionChange")) && (t = Le(e, t, r));
    var n = r && r.bias || (Go(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
    Ne(e, Ae(e, t, n, !0)), r && r.scroll === !1 || !e.cm || Fr(e.cm)
  }

  function Ne(e, t) {
    t.equals(e.sel) || (e.sel = t, e.cm && (e.cm.curOp.updateInput = e.cm.curOp.selectionChanged = !0, Ni(e.cm)), Ti(e, "cursorActivity", e))
  }

  function We(e) {
    Ne(e, Ae(e, e.sel, null, !1), Rl)
  }
    ...
    if (o.markedSpans)
      for (var l = 0; l < o.markedSpans.length; ++l) {
        ...
        if ((null == s.from || (a.inclusiveLeft ? s.from <= t.ch : s.from < t.ch)) && (null == s.to || (a.inclusiveRight ? s.to >= t.ch : s.to > t.ch))) {
          if (i && (El(a, "beforeCursorEnter"), a.explicitlyCleared)) {
            if (o.markedSpans) {
              --l;
              continue
            }
          ...
          if (r) {
            var u, c = a.find(n < 0 ? 1 : -1);
            if ((n < 0 ? a.inclusiveRight : a.inclusiveLeft) && (c = He(e, c, -n, c && c.line == t.line ? o : null)), c && c.line == t.line && (u = Go(c, r)) && (n < 0 ? u < 0 : u > 0)) return Oe(e, c, t, n, i)
          }
          var h = a.find(n < 0 ? -1 : 1);
          return (n < 0 ? a.inclusiveLeft : a.inclusiveRight) && (h = He(e, h, n, h.line == t.line ? o : null)), h ? Oe(e, h, t, n, i) : null
        }
      }
    return t
  }
  ...
  function De(e, t, r, n, i) {
    ...
    return l ? l : (e.cantEdit = !0, Bo(e.first, 0))
  }

  function He(e, t, r, n) {
    return r < 0 && 0 == t.ch ? t.line > e.first ? ge(e, Bo(t.line - 1)) : null : r > 0 && t.ch == (n || Qn(e, t.line)).text.length ? t.line < e.first + e.size - 1 ? Bo(t.line + 1, 0) : null : new Bo(t.line, t.ch + r)
  }
  ...
  function Ie(e, t, r) {
    var n = pt(e, t, "div", null, null, !e.options.singleCursorHeightPerLine),
  ...
  function ze(e, t, r) {
    function n(e, t, r, n) {
      t < 0 && (t = 0), t = Math.round(t), n = Math.round(n), s.appendChild(Ki("div", null, "CodeMirror-selected", "position: absolute; left: " + e + "px; top: " + t + "px; width: " + (null == r ? c - e : r) + "px; height: " + (n - t) + "px"))
    }

    function i(t, r, i) {
      function o(r, n) {
        return dt(e, Bo(t, r), "div", h, n)
      }
      var s, a, h = Qn(l, t),
        f = h.text.length;
      return ro(oi(h), r || 0, null == i ? f : i, function (e, t, l) {
        ...
        null == r && 0 == e && (d = u), h.top - g.top > 3 && (n(d, g.top, null, g.bottom), d = u, g.bottom < h.top && n(d, g.bottom, null, h.top)), null == i && t == f && (p = c), (!s || g.top < s.top || g.top == s.top && g.left < s.left) && (s = g), (!a || h.bottom > a.bottom || h.bottom == a.bottom && h.right > a.right) && (a = h), d < u + 1 && (d = u), n(d, h.top, p - d, h.bottom)
      }), {
        start: s,
        end: a
      }
  ...
  function Re(e, t) {
    e.doc.mode.startState && e.doc.frontier < e.display.viewTo && e.state.highlight.set(t, Bi(Be, e))
  }
    ...
    if (t.frontier < t.first && (t.frontier = t.first), !(t.frontier >= e.display.viewTo)) {
      ...
      t.iter(t.frontier, Math.min(t.first + t.size, e.display.viewTo + 500), function (o) {
        if (t.frontier >= e.display.viewFrom) {
          ...
          h && i.push(t.frontier), o.stateAfter = s ? n : cl(t.mode, n)
        } else o.text.length <= e.options.maxHighlightLength && zn(e, o.text, n), o.stateAfter = t.frontier % 5 == 0 ? cl(t.mode, n) : null;
        if (++t.frontier, +new Date > r) return Re(e, e.options.workDelay), !0
  ...
  function Ge(e, t, r) {
    for (var n, i, o = e.doc, l = r ? -1 : t - (e.doc.mode.innerMode ? 1e3 : 100), s = t; s > l; --s) {
      ...
      var u = Ul(a.text, null, e.options.tabSize);
  ...
  function Ue(e, t, r) {
    ...
    var o = Ge(e, t, r),
      l = o > n.first && Qn(n, o - 1).stateAfter;
    return l = l ? cl(n.mode, l) : hl(n.mode), n.iter(o, t, function (r) {
      zn(e, r.text, l);
      var s = o == t - 1 || o % 5 == 0 || o >= i.viewFrom && o < i.viewTo;
      r.stateAfter = s ? cl(n.mode, l) : null, ++o
    }), r && (n.frontier = o), l
  }
  ...
  function Xe(e) {
    return zl - e.display.nativeBarWidth
  }
  ...
  function Ze(e, t) {
    t = bn(t);
    var r = ri(t),
      n = e.display.externalMeasured = new Pt(e.doc, t, r);
    n.lineN = r;
    var i = n.built = Rn(e, n);
    return n.text = i.pre, Xi(e.display.lineMeasure, i.pre), n
  }
  ...
  function tt(e, t, r, n, i) {
    t.before && (r = -1);
    var o, l = r + (n || "");
    return t.cache.hasOwnProperty(l) ? o = t.cache[l] : (t.rect || (t.rect = t.view.text.getBoundingClientRect()), t.hasHeights || (qe(e, t.view, t.rect), t.hasHeights = !0), o = it(e, t, r, n), o.bogus || (t.cache[l] = o)), {
      left: o.left,
      right: o.right,
      top: i ? o.rtop : o.top,
  ...
  function rt(e, t, r) {
    for (var n, i, o, l, s = 0; s < e.length; s += 3) {
      var a = e[s],
        u = e[s + 1];
      if (t < a ? (i = 0, o = 1, l = "left") : t < u ? (i = t - a, o = i + 1) : (s == e.length - 3 || t == u && e[s + 3] > t) && (o = u - a, i = o - 1, t >= u && (l = "right")), null != i) {
        if (n = e[s + 2], a == u && r == (n.insertLeft ? "left" : "right") && (l = r), "left" == r && 0 == i)
          for (; s && e[s - 2] == e[s - 3] && e[s - 1].insertLeft;) n = e[(s -= 3) + 2], l = "left";
        if ("right" == r && i == u - a)
          for (; s < e.length - 3 && e[s + 3] == e[s + 4] && !e[s + 5].insertLeft;) n = e[(s += 3) + 2], l = "right";
        break
      }
    }
    return {
  ...
  function nt(e, t) {
    ...
    if ("left" == t)
      ...
      for (var n = e.length - 1; n >= 0 && (r = e[n]).left == r.right; n--);
    return r
  }
  ...
  function it(e, t, r, n) {
    ...
    if (3 == l.nodeType) {
      for (var c = 0; c < 4; c++) {
        for (; s && Vi(t.line.text.charAt(o.coverStart + s));) --s;
  ...
  function ot(e, t) {
    if (!window.screen || null == screen.logicalXDPI || screen.logicalXDPI == screen.deviceXDPI || !to(e)) return t;
  ...
  function st(e) {
    ...
    for (var t = 0; t < e.display.view.length; t++) lt(e.display.view[t])
  }
  ...
  function ht(e, t, r, n) {
    ...
    if ("local" == n ? l += Ve(e.display) : l -= e.display.viewOffset, "page" == n || "window" == n) {
      ...
      l += s.top + ("window" == n ? 0 : ct());
      var a = s.left + ("window" == n ? 0 : ut());
      r.left += a, r.right += a
    }
  ...
  function dt(e, t, r, n, i) {
    return n || (n = Qn(e.doc, t.line)), ht(e, n, Qe(e, n, t.ch, i), r)
  }

  function pt(e, t, r, n, i, o) {
    function l(t, l) {
      var s = tt(e, i, t, l ? "right" : "left", o);
      return l ? s.left = s.right : s.right = s.left, ht(e, n, s, r)
    }

    function s(e, t) {
      var r = a[t],
        n = r.level % 2;
      return e == no(r) && t && r.level < a[t - 1].level ? (r = a[--t], e = io(r) - (r.level % 2 ? 0 : 1), n = !0) : e == io(r) && t < a.length - 1 && r.level < a[t + 1].level && (r = a[++t], e = no(r) - r.level % 2, n = !1), n && e == r.to && e > r.from ? l(e - 1) : l(e, n)
    }
    n = n || Qn(e.doc, t.line), i || (i = et(e, n));
    var a = oi(n),
      u = t.ch;
    if (!a) return l(u);
    var c = ho(a, u),
      h = s(u, c);
    return null != as && (h.other = s(u, as)), h
  }
  ...
  function mt(e, t, r) {
    ...
    var i = ni(n, r),
      o = n.first + n.size - 1;
    if (i > o) return vt(n.first + n.size - 1, Qn(n, o).text.length, !0, 1);
    t < 0 && (t = 0);
    for (var l = Qn(n, i);;) {
      var s = yt(e, l, i, t, r),
        a = mn(l),
  ...
  function yt(e, t, r, n, i) {
    ...
    for (;;) {
      if (c ? d == f || d == po(t, f, 1) : d - f <= 1) {
        var y = n < p || n - p <= v - n ? f : d,
          b = y == f ? g : m,
          w = n - (y == f ? p : v);
        if (m && !c && !/\s/.test(t.text.charAt(y)) && w > 0 && y < t.text.length && u.view.measure.heights.length > 1) {
          var x = tt(e, u, y, "right");
          l <= x.bottom && l >= x.top && Math.abs(n - x.right) < w && (b = !1, y++, w = n - x.right)
        }
        for (; Vi(t.text.charAt(y));) ++y;
      ...
      if (c) {
        L = f;
        for (var T = 0; T < S; ++T) L = po(t, L, 1)
      }
      var k = o(L);
      k > n ? (d = L, v = k, (m = s) && (v += 1e3), h = S) : (f = L, p = k, g = s, h -= S)
    }
  }
  ...
  function bt(e) {
    ...
    if (null == Vo) {
      ...
      Vo.appendChild(document.createTextNode("x"))
    }
    Xi(e.measure, Vo);
  ...
  function xt(e) {
    e.curOp = {
      ...
      focus: !1,
      id: ++_o
    }, Yo ? Yo.ops.push(e.curOp) : e.curOp.ownsGroup = Yo = {
      ops: [e.curOp],
      delayedCallbacks: []
    }
  }
  ...
  function Mt(e) {
    var t = e.cm,
      r = t.display;
    e.updatedDisplay && O(t), e.barMeasure = p(t), r.maxLineChanged && !t.options.lineWrapping && (e.adjustWidthTo = Qe(t, r.maxLine, r.maxLine.text.length).left + 3, t.display.sizerWidth = e.adjustWidthTo, e.barMeasure.scrollWidth = Math.max(r.scroller.clientWidth, r.sizer.offsetLeft + e.adjustWidthTo + Xe(t) + t.display.barWidth), e.maxScrollLeft = Math.max(0, r.sizer.offsetLeft + e.adjustWidthTo - Ye(t))), (e.updatedDisplay || e.selectionChanged) && (e.preparedSelection = r.input.prepareSelection(e.focus))
  }
  ...
  function Nt(e) {
    ...
    e.preparedSelection && t.display.input.showSelection(e.preparedSelection, r), (e.updatedDisplay || e.startHeight != t.doc.height) && y(t, e.barMeasure), e.updatedDisplay && A(t, e.barMeasure), e.selectionChanged && Fe(t), t.state.focused && e.updateInput && t.display.input.reset(e.typing), r && $(e.cm)
  }
  ...
  function Wt(e) {
    ...
    if (e.updatedDisplay && N(t, e.update), null == r.wheelStartX || null == e.scrollTop && null == e.scrollLeft && !e.scrollToPos || (r.wheelStartX = r.wheelStartY = null), null == e.scrollTop || r.scroller.scrollTop == e.scrollTop && !e.forceScroll || (n.scrollTop = Math.max(0, Math.min(r.scroller.scrollHeight - r.scroller.clientHeight, e.scrollTop)), r.scrollbars.setScrollTop(n.scrollTop), r.scroller.scrollTop = n.scrollTop), null == e.scrollLeft || r.scroller.scrollLeft == e.scrollLeft && !e.forceScroll || (n.scrollLeft = Math.max(0, Math.min(r.scroller.scrollWidth - r.scroller.clientWidth, e.scrollLeft)), r.scrollbars.setScrollLeft(n.scrollLeft), r.scroller.scrollLeft = n.scrollLeft, x(t)), e.scrollToPos) {
      var i = Pr(t, ge(n, e.scrollToPos.from), ge(n, e.scrollToPos.to), e.scrollToPos.margin);
      e.scrollToPos.isCursor && t.state.focused && Hr(t, i)
    }
    var o = e.maybeHiddenMarkers,
      l = e.maybeUnhiddenMarkers;
    if (o)
      for (var s = 0; s < o.length; ++s) o[s].lines.length || El(o[s], "hide");
    if (l)
      for (var s = 0; s < l.length; ++s) l[s].lines.length && El(l[s], "unhide");
    r.wrapper.offsetHeight && (n.scrollTop = t.display.scroller.scrollTop), e.changeObjs && El(t, "changes", t, e.changeObjs), e.update && e.update.finish()
  }
  ...
  function Pt(e, t, r) {
    this.line = t, this.rest = wn(t), this.size = this.rest ? ri(Hi(this.rest)) - r + 1 : 1, this.node = this.text = null, this.hidden = Sn(e, t)
  }

  function Et(e, t, r) {
    for (var n, i = [], o = t; o < r; o = n) {
      var l = new Pt(e.doc, Qn(e.doc, o), o);
      n = o + l.size, i.push(l)
    }
    return i
  }
  ...
  function It(e, t, r, n) {
    ...
    var i = e.display;
    if (n && r < i.viewTo && (null == i.updateLineNumbers || i.updateLineNumbers > t) && (i.updateLineNumbers = t), e.curOp.viewChanged = !0, t >= i.viewTo) Ro && xn(e.doc, t) < i.viewTo && Ft(e);
    else if (r <= i.viewFrom) Ro && Cn(e.doc, r + n) > i.viewFrom ? Ft(e) : (i.viewFrom += n, i.viewTo += n);
    else if (t <= i.viewFrom && r >= i.viewTo) Ft(e);
      ...
      var l = Bt(e, t, t, -1),
        s = Bt(e, r, r + n, 1);
      l && s ? (i.view = i.view.slice(0, l.index).concat(Et(e, l.lineN, s.lineN)).concat(i.view.slice(s.index)), i.viewTo += n) : Ft(e)
    }
  ...
  function Bt(e, t, r, n) {
    var i, o = Rt(e, t),
      l = e.display.view;
    if (!Ro || r == e.doc.first + e.doc.size) return {
      index: o,
      lineN: r
    };
  ...
  function Gt(e, t, r) {
    var n = e.display,
      i = n.view;
    0 == i.length || t >= n.viewTo || r <= n.viewFrom ? (n.view = Et(e, t, r), n.viewFrom = t) : (n.viewFrom > t ? n.view = Et(e, t, n.viewFrom).concat(n.view) : n.viewFrom < t && (n.view = n.view.slice(Rt(e, t))), n.viewFrom = t, n.viewTo < r ? n.view = n.view.concat(Et(e, n.viewTo, r)) : n.viewTo > r && (n.view = n.view.slice(0, Rt(e, r)))), n.viewTo = r
  }
  ...
  function Vt(e) {
    ...
    var i = e.display;
    Dl(i.scroller, "mousedown", Ot(e, _t)), xo && Co < 11 ? Dl(i.scroller, "dblclick", Ot(e, function (t) {
      if (!Mi(e, t)) {
        var r = Yt(e, t);
        if (r && !Jt(e, t) && !Xt(e.display, t)) {
          Wl(t);
          var n = e.findWordAt(r);
          we(e.doc, n.anchor, n.head)
        }
      }
    })) : Dl(i.scroller, "dblclick", function (t) {
      Mi(e, t) || Wl(t)
    }), zo || Dl(i.scroller, "contextmenu", function (t) {
      br(e, t)
    });
    var o, l = {
      end: 0
    };
    Dl(i.scroller, "touchstart", function (t) {
      if (!Mi(e, t) && !r(t)) {
        clearTimeout(o);
        var n = +new Date;
        i.activeTouch = {
    ...
    }), Dl(i.scroller, "touchmove", function () {
      i.activeTouch && (i.activeTouch.moved = !0)
    }), Dl(i.scroller, "touchend", function (r) {
      var o = i.activeTouch;
      if (o && !Xt(i, r) && null != o.left && !o.moved && new Date - o.start < 300) {
        var l, s = e.coordsChar(i.activeTouch, "page");
        l = !o.prev || n(o, o.prev) ? new he(s, s) : !o.prev.prev || n(o, o.prev.prev) ? e.findWordAt(s) : new he(Bo(s.line, 0), ge(e.doc, Bo(s.line + 1, 0))), e.setSelection(l.anchor, l.head), e.focus(), Wl(r)
      }
      t()
    }), Dl(i.scroller, "touchcancel", t), Dl(i.scroller, "scroll", function () {
      i.scroller.clientHeight && (ir(e, i.scroller.scrollTop), or(e, i.scroller.scrollLeft, !0), El(e, "scroll", e))
    }), Dl(i.scroller, "mousewheel", function (t) {
      lr(e, t)
    }), Dl(i.scroller, "DOMMouseScroll", function (t) {
      lr(e, t)
    }), Dl(i.wrapper, "scroll", function () {
    ...
    Dl(s, "keyup", function (t) {
      pr.call(e, t)
    }), Dl(s, "keydown", Ot(e, fr)), Dl(s, "keypress", Ot(e, gr)), Dl(s, "focus", function (t) {
      mr(e, t)
    }), Dl(s, "blur", function (t) {
      yr(e, t)
    })
  }
  ...
  function Xt(e, t) {
    for (var r = Ci(t); r != e.wrapper; r = r.parentNode)
  ...
  function Yt(e, t, r, n) {
    ...
    var a, u = mt(e, o, l);
    if (n && 1 == u.xRel && (a = Qn(e.doc, u.line).text).length == u.ch) {
      var c = Ul(a, a.length, e.options.tabSize) - a.length;
      u = Bo(u.line, Math.max(0, Math.round((o - je(e.display).left) / wt(e.display)) - c))
    }
    return u
  }
  ...
  function _t(e) {
    ...
    if (!(Mi(t, e) || r.activeTouch && r.input.supportsTouch())) {
      if (r.shift = e.shiftKey, Xt(r, e)) return void(So || (r.scroller.draggable = !1, setTimeout(function () {
        r.scroller.draggable = !0
      }, 100)));
      if (!Jt(t, e)) {
        var n = Yt(t, e);
        switch (window.focus(), Si(e)) {
          case 1:
            t.state.selectingText ? t.state.selectingText(e) : n ? qt(t, e, n) : Ci(e) == r.scroller && Wl(e);
            break;
          case 2:
            So && (t.state.lastMiddleDown = +new Date), n && we(t.doc, n), setTimeout(function () {
              r.input.focus()
            }, 20), Wl(e);
            break;
          case 3:
  ...
  function qt(e, t, r) {
    xo ? setTimeout(Bi($, e), 0) : e.curOp.focus = Yi();
    var n, i = +new Date;
    jo && jo.time > i - 400 && 0 == Go(jo.pos, r) ? n = "triple" : Ko && Ko.time > i - 400 && 0 == Go(Ko.pos, r) ? (n = "double", jo = {
      time: i,
      pos: r
    }) : (n = "single", Ko = {
      time: i,
    ...
    var o, l = e.doc.sel,
      s = Do ? t.metaKey : t.ctrlKey;
    e.options.dragDrop && rs && !e.isReadOnly() && "single" == n && (o = l.contains(r)) > -1 && (Go((o = l.ranges[o]).from(), r) < 0 || r.xRel > 0) && (Go(o.to(), r) > 0 || r.xRel < 0) ? $t(e, t, r, s) : Zt(e, t, r, n, s)
  }
  ...
  function $t(e, t, r, n) {
    var i = e.display,
      o = +new Date,
      l = Ot(e, function (s) {
        So && (i.scroller.draggable = !1), e.state.draggingText = !1, Pl(document, "mouseup", l), Pl(i.scroller, "drop", l), Math.abs(t.clientX - s.clientX) + Math.abs(t.clientY - s.clientY) < 10 && (Wl(s), !n && +new Date - 200 < o && we(e.doc, r), So || xo && 9 == Co ? setTimeout(function () {
          document.body.focus(), i.input.focus()
        }, 20) : i.input.focus())
      });
    So && (i.scroller.draggable = !0), e.state.draggingText = l, l.copy = Do ? t.altKey : t.ctrlKey, i.scroller.dragDrop && i.scroller.dragDrop(), Dl(document, "mouseup", l), Dl(i.scroller, "drop", l)
  }
  ...
  function Zt(e, t, r, n, i) {
    function o(t) {
      if (0 != Go(v, t))
        if (v = t, "rect" == n) {
          for (var i = [], o = e.options.tabSize, l = Ul(Qn(u, r.line).text, r.ch, o), s = Ul(Qn(u, t.line).text, t.ch, o), a = Math.min(l, s), d = Math.max(l, s), p = Math.min(r.line, t.line), g = Math.min(e.lastLine(), Math.max(r.line, t.line)); p <= g; p++) {
            var m = Qn(u, p).text,
              y = Vl(m, a, o);
            a == d ? i.push(new he(Bo(p, y), Bo(p, y))) : m.length > y && i.push(new he(Bo(p, y), Bo(p, Vl(m, d, o))))
          }
          ...
          if ("single" != n) {
            ...
            else var C = new he(Bo(t.line, 0), ge(u, Bo(t.line + 1, 0)));
            Go(C.anchor, w) > 0 ? (x = C.head, w = q(b.from(), C.anchor)) : (x = C.anchor, w = _(b.to(), C.head))
          }
          var i = f.ranges.slice(0);
          i[h] = new he(ge(u, w), x), ke(u, fe(i, h), Bl)
        }
    }
    ...
    function s(t) {
      e.state.selectingText = !1, y = 1 / 0, Wl(t), a.input.focus(), Pl(document, "mousemove", b), Pl(document, "mouseup", x), u.history.lastSelOrigin = null
    }
    var a = e.display,
      u = e.doc;
    Wl(t);
    var c, h, f = u.sel,
      d = f.ranges;
    if (i && !t.shiftKey ? (h = u.sel.contains(r), c = h > -1 ? d[h] : new he(r, r)) : (c = u.sel.primary(), h = u.sel.primIndex), Ho ? t.shiftKey && t.metaKey : t.altKey) n = "rect", i || (c = new he(r, r)), r = Yt(e, t, !0, !0), h = -1;
    else if ("double" == n) {
      var p = e.findWordAt(r);
      c = e.display.shift || u.extend ? be(u, c, p.anchor, p.head) : p
    } else if ("triple" == n) {
      var g = new he(Bo(r.line, 0), ge(u, Bo(r.line + 1, 0)));
      c = e.display.shift || u.extend ? be(u, c, g.anchor, g.head) : g
    } else c = be(u, c, r);
    i ? h == -1 ? (h = d.length, ke(u, fe(d.concat([c]), h), {
      scroll: !1,
      origin: "*mouse"
    })) : d.length > 1 && d[h].empty() && "single" == n && !t.shiftKey ? (ke(u, fe(d.slice(0, h).concat(d.slice(h + 1)), 0), {
      scroll: !1,
      origin: "*mouse"
    }), f = u.sel) : Ce(u, h, c, Bl) : (h = 0, ke(u, new ce([c], 0), Bl), f = u.sel);
    var v = r,
      ...
      x = Ot(e, s);
    e.state.selectingText = x, Dl(document, "mousemove", b), Dl(document, "mouseup", x)
  }
  ...
  function Qt(e, t, r, n) {
    ...
    if (o > s.bottom || !Wi(e, r)) return xi(t);
      ...
      if (r && !t.isReadOnly())
        if (n && n.length && window.FileReader && window.File)
          for (var i = n.length, o = Array(i), l = 0, s = function (e, n) {
              if (!t.options.allowDropFileTypes || Pi(t.options.allowDropFileTypes, e.type) != -1) {
          ...
          try {
            ...
            if (o) {
              ...
              if (Me(t.doc, de(r, r)), u)
                for (var a = 0; a < u.length; ++a) Dr(t.doc, "", u[a].anchor, u[a].head, "drag");
  ...
  function tr(e, t) {
    if (xo && (!e.state.draggingText || +new Date - qo < 100)) return void Ol(t);
    if (!Mi(e, t) && !Xt(e.display, t) && (t.dataTransfer.setData("Text", e.getSelection()), t.dataTransfer.effectAllowed = "copyMove", t.dataTransfer.setDragImage && !Mo)) {
      var r = Ki("img", null, null, "position: fixed; left: 0; top: 0;");
      r.src = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", ko && (r.width = r.height = 1, e.display.wrapper.appendChild(r), r._top = r.offsetTop), t.dataTransfer.setDragImage(r, 0, 0), ko && r.parentNode.removeChild(r)
    }
  }
  ...
  function rr(e, t) {
    ...
    if (r) {
      ...
      Ie(e, r, n), e.display.dragCursor || (e.display.dragCursor = Ki("div", null, "CodeMirror-cursors CodeMirror-dragcursors"), e.display.lineSpace.insertBefore(e.display.dragCursor, e.display.cursorDiv)), Xi(e.display.dragCursor, n)
    }
  }
  ...
  function ir(e, t) {
    Math.abs(e.doc.scrollTop - t) < 2 || (e.doc.scrollTop = t, yo || W(e, {
      top: t
    }), e.display.scroller.scrollTop != t && (e.display.scroller.scrollTop = t), e.display.scrollbars.setScrollTop(t), yo && W(e), Re(e, 100))
  }
  ...
  function lr(e, t) {
    ...
    if (n && s || i && a) {
      if (i && Do && So) e: for (var u = t.target, c = o.view; u != l; u = u.parentNode)
        for (var h = 0; h < c.length; h++)
          if (c[h].node == u) {
            e.display.currentWheelTarget = u;
            break e
          } if (n && !yo && !ko && null != Zo) return i && a && ir(e, Math.max(0, Math.min(l.scrollTop + i * Zo, l.scrollHeight - l.clientHeight))), or(e, Math.max(0, Math.min(l.scrollLeft + n * Zo, l.scrollWidth - l.clientWidth))), (!i || i && a) && Wl(t), void(o.wheelStartX = null);
      if (i && null != Zo) {
        var f = i * Zo,
          d = e.doc.scrollTop,
          p = d + o.wrapper.clientHeight;
        f < 0 ? d = Math.max(0, d + f - 50) : p = Math.min(e.doc.height, p + f + 50), W(e, {
          top: d,
          bottom: p
        })
      }
      $o < 20 && (null == o.wheelStartX ? (o.wheelStartX = l.scrollLeft, o.wheelStartY = l.scrollTop, o.wheelDX = n, o.wheelDY = i, setTimeout(function () {
  ...
  function sr(e, t, r) {
    if ("string" == typeof t && (t = fl[t], !t)) return !1;
    e.display.input.ensurePolled();
    var n = e.display.shift,
      i = !1;
    try {
      e.isReadOnly() && (e.state.suppressEdits = !0), r && (e.display.shift = !1), i = t(e) != Fl
    } finally {
  ...
  function ar(e, t, r) {
    for (var n = 0; n < e.state.keyMaps.length; n++) {
      var i = pl(t, e.state.keyMaps[n], r, e);
      if (i) return i
    }
    return e.options.extraKeys && pl(t, e.options.extraKeys, r, e) || pl(t, e.options.keyMap, r, e)
  }
  ...
  function ur(e, t, r, n) {
    ...
    var o = ar(e, t, n);
    return "multi" == o && (e.state.keySeq = t), "handled" == o && Ti(e, "keyHandled", e, t, r), "handled" != o && "multi" != o || (Wl(r), Fe(e)), i && !o && /\'$/.test(t) ? (Wl(r), !0) : !!o
  }

  function cr(e, t) {
    var r = vl(t, !0);
    return !!r && (t.shiftKey && !e.state.keySeq ? ur(e, "Shift-" + r, t, function (t) {
      return sr(e, t, !0)
    }) || ur(e, r, t, function (t) {
      if ("string" == typeof t ? /^go[A-Z]/.test(t) : t.motion) return sr(e, t)
    }) : ur(e, r, t, function (t) {
      return sr(e, t)
    }))
  }
  ...
  function fr(e) {
    var t = this;
    if (t.curOp.focus = Yi(), !Mi(t, e)) {
      xo && Co < 11 && 27 == e.keyCode && (e.returnValue = !1);
      var r = e.keyCode;
      t.display.shift = 16 == r || e.shiftKey;
      var n = cr(t, e);
      ko && (el = n ? r : null, !n && 88 == r && !os && (Do ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null, "cut")), 18 != r || /\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) || dr(t)
    }
  }

  function dr(e) {
    function t(e) {
      18 != e.keyCode && e.altKey || (Jl(r, "CodeMirror-crosshair"), Pl(document, "keyup", t), Pl(document, "mouseover", t))
    }
    var r = e.display.lineDiv;
    es(r, "CodeMirror-crosshair"), Dl(document, "keyup", t), Dl(document, "mouseover", t)
  }
  ...
  function gr(e) {
    var t = this;
    if (!(Xt(t.display, e) || Mi(t, e) || e.ctrlKey && !e.altKey || Do && e.metaKey)) {
      var r = e.keyCode,
        n = e.charCode;
      if (ko && r == el) return el = null, void Wl(e);
      if (!ko || e.which && !(e.which < 10) || !cr(t, e)) {
        var i = String.fromCharCode(null == n ? r : n);
        hr(t, e, i) || t.display.input.onKeyPress(e)
      }
    }
  }
  ...
  function mr(e, t) {
    e.state.delayingBlurEvent && (e.state.delayingBlurEvent = !1), "nocursor" != e.options.readOnly && (e.state.focused || (El(e, "focus", e, t), e.state.focused = !0, es(e.display.wrapper, "CodeMirror-focused"), e.curOp || e.display.selForContextMenu == e.doc.sel || (e.display.input.reset(), So && setTimeout(function () {
      e.display.input.reset(!0)
    }, 20)), e.display.input.receivedFocus()), Fe(e))
  }

  function yr(e, t) {
    e.state.delayingBlurEvent || (e.state.focused && (El(e, "blur", e, t), e.state.focused = !1, Jl(e.display.wrapper, "CodeMirror-focused")), clearInterval(e.display.blinker), setTimeout(function () {
      e.state.focused || (e.display.shift = !1)
    }, 150))
  }

  function br(e, t) {
    Xt(e.display, t) || wr(e, t) || Mi(e, t, "contextmenu") || e.display.input.onContextMenu(t)
  }

  function wr(e, t) {
    return !!Wi(e, "gutterContextMenu") && Qt(e, t, "gutterContextMenu", !1)
  }

  function xr(e, t) {
    if (Go(e, t.from) < 0) return e;
    if (Go(e, t.to) <= 0) return tl(t);
    var r = e.line + t.text.length - (t.to.line - t.from.line) - 1,
      n = e.ch;
    return e.line == t.to.line && (n += tl(t).ch - t.to.ch), Bo(r, n)
  }
  ...
  function Sr(e, t, r) {
    return e.line == t.line ? Bo(r.line, e.ch - t.ch + r.ch) : Bo(r.line + (e.line - t.line), e.ch)
  }

  function Lr(e, t, r) {
    for (var n = [], i = Bo(e.first, 0), o = i, l = 0; l < t.length; l++) {
      var s = t[l],
        a = Sr(s.from, i, o),
        u = Sr(tl(s), i, o);
      if (i = s.to, o = u, "around" == r) {
        var c = e.sel.ranges[l],
          h = Go(c.head, c.anchor) < 0;
  ...
  function Tr(e, t, r) {
    ...
    }), El(e, "beforeChange", e, n), e.cm && El(e.cm, "beforeChange", e.cm, n), n.canceled ? null : {
      from: n.from,
      to: n.to,
      text: n.text,
      origin: n.origin
  ...
  function kr(e, t, r) {
    if (e.cm) {
      if (!e.cm.curOp) return Ot(e.cm, kr)(e, t, r);
      if (e.cm.state.suppressEdits) return
    }
    if (!(Wi(e, "beforeChange") || e.cm && Wi(e.cm, "beforeChange")) || (t = Tr(e, t, !0))) {
      var n = Fo && !r && un(e, t.from, t.to);
      if (n)
  ...
  function Mr(e, t) {
    if (1 != t.text.length || "" != t.text[0] || 0 != Go(t.from, t.to)) {
      var r = Cr(e, t);
      ci(e, t, r, e.cm ? e.cm.curOp.id : NaN), Ar(e, t, r, ln(e, t));
      var n = [];
      $n(e, function (e, r) {
        r || Pi(n, e.history) != -1 || (wi(e.history, t), n.push(e.history)), Ar(e, t, null, ln(e, t))
      })
    }
  }
    ...
    if (!e.cm || !e.cm.state.suppressEdits || r) {
      ...
      if (a != l.length) {
        for (i.lastOrigin = i.lastSelOrigin = null; n = l.pop(), n.ranges;) {
          if (di(n, s), r && !n.equals(e.sel)) return void ke(e, n, {
            clearRedo: !1
          });
          o = n
        }
        ...
        for (var c = Wi(e, "beforeChange") || e.cm && Wi(e.cm, "beforeChange"), a = n.changes.length - 1; a >= 0; --a) {
          var h = n.changes[a];
          if (h.origin = t, c && !Tr(e, h, !1)) return void(l.length = 0);
          u.push(si(e, h));
          var f = a ? Cr(e, h) : Hi(l);
          Ar(e, h, f, an(e, h)), !a && e.cm && e.cm.scrollIntoView({
            from: h.from,
            to: tl(h)
          });
          var d = [];
          $n(e, function (e, t) {
            t || Pi(d, e.history) != -1 || (wi(e.history, h), d.push(e.history)), Ar(e, h, null, an(e, h))
          })
        }
      }
    }
  ...
  function Wr(e, t) {
    if (0 != t && (e.first += t, e.sel = new ce(Ei(e.sel.ranges, function (e) {
        return new he(Bo(e.anchor.line + t, e.anchor.ch), Bo(e.head.line + t, e.head.ch))
  ...
  function Ar(e, t, r, n) {
    if (e.cm && !e.cm.curOp) return Ot(e.cm, Ar)(e, t, r, n);
    if (t.to.line < e.first) return void Wr(e, t.text.length - 1 - (t.to.line - t.from.line));
    if (!(t.from.line > e.lastLine())) {
      ...
      t.to.line > o && (t = {
        from: t.from,
        to: Bo(o, Qn(e, o).text.length),
        text: [t.text[0]],
        origin: t.origin
      }), t.removed = Jn(e, t.from, t.to), r || (r = Cr(e, t)), e.cm ? Or(e.cm, t, n) : Yn(e, t, n), Me(e, r, Rl)
    }
  }
  ...
  function Or(e, t, r) {
    var n = e.doc,
      ...
      a = !1,
      u = l.line;
    e.options.lineWrapping || (u = ri(bn(Qn(n, l.line))), n.iter(u, s.line + 1, function (e) {
      if (e == i.maxLine) return a = !0, !0
    })), n.sel.contains(t.from, t.to) > -1 && Ni(e), Yn(n, t, r, o(e)), e.options.lineWrapping || (n.iter(u, l.line + t.text.length, function (e) {
      var t = h(e);
    ...
    t.full ? It(e) : l.line != s.line || 1 != t.text.length || Xn(e.doc, t) ? It(e, l.line, s.line + 1, c) : zt(e, l.line, "text");
    var f = Wi(e, "changes"),
      d = Wi(e, "change");
    if (d || f) {
      var p = {
      ...
      d && Ti(e, "change", e, p), f && (e.curOp.changeObjs || (e.curOp.changeObjs = [])).push(p)
    }
  ...
  function Dr(e, t, r, n, i) {
    ...
    "string" == typeof t && (t = e.splitLines(t)), kr(e, {
      from: r,
      to: n,
      text: t,
      origin: i
  ...
  function Hr(e, t) {
    if (!Mi(e, "scrollCursorIntoView")) {
      var r = e.display,
        ...
        i = null;
      if (t.top + n.top < 0 ? i = !0 : t.bottom + n.top > (window.innerHeight || document.documentElement.clientHeight) && (i = !1), null != i && !Wo) {
        var o = Ki("div", "​", null, "position: absolute; top: " + (t.top - r.viewOffset - Ve(e.display)) + "px; height: " + (t.bottom - t.top + Xe(e) + r.barHeight) + "px; left: " + t.left + "px; width: 2px;");
  ...
  function Pr(e, t, r, n) {
    ...
    for (var i = 0; i < 5; i++) {
      var o = !1,
        l = pt(e, t),
        s = r && r != t ? pt(e, r) : l,
        a = Ir(e, Math.min(l.left, s.left), Math.min(l.top, s.top) - n, Math.max(l.left, s.left), Math.max(l.bottom, s.bottom) + n),
        u = e.doc.scrollTop,
        c = e.doc.scrollLeft;
      if (null != a.scrollTop && (ir(e, a.scrollTop), Math.abs(e.doc.scrollTop - u) > 1 && (o = !0)), null != a.scrollLeft && (or(e, a.scrollLeft), Math.abs(e.doc.scrollLeft - c) > 1 && (o = !0)), !o) break
    }
    return l
  }
  ...
  function Er(e, t, r, n, i) {
    var o = Ir(e, t, r, n, i);
    null != o.scrollTop && ir(e, o.scrollTop), null != o.scrollLeft && or(e, o.scrollLeft)
  }
  ...
  function Ir(e, t, r, n, i) {
    ...
    var p = e.curOp && null != e.curOp.scrollLeft ? e.curOp.scrollLeft : o.scroller.scrollLeft,
      ...
      v = n - t > g;
    return v && (n = t + g), t < 10 ? u.scrollLeft = 0 : t < p ? u.scrollLeft = Math.max(0, t - (v ? 0 : 10)) : n > g + p - 3 && (u.scrollLeft = n + (v ? 0 : 10) - g), u
  }

  function zr(e, t, r) {
    null == t && null == r || Rr(e), null != t && (e.curOp.scrollLeft = (null == e.curOp.scrollLeft ? e.doc.scrollLeft : e.curOp.scrollLeft) + t), null != r && (e.curOp.scrollTop = (null == e.curOp.scrollTop ? e.doc.scrollTop : e.curOp.scrollTop) + r)
  }
  ...
  function Fr(e) {
    ...
    var t = e.getCursor(),
      r = t,
      n = t;
    e.options.lineWrapping || (r = t.ch ? Bo(t.line, t.ch - 1) : t, n = Bo(t.line, t.ch + 1)), e.curOp.scrollToPos = {
      from: r,
      to: n,
  ...
  function Rr(e) {
    ...
    if (t) {
      ...
      var r = gt(e, t.from),
        n = gt(e, t.to),
        i = Ir(e, Math.min(r.left, n.left), Math.min(r.top, n.top) - t.margin, Math.max(r.right, n.right), Math.max(r.bottom, n.bottom) + t.margin);
  ...
  function Br(e, t, r, n) {
    ...
    if (n || /\S/.test(s.text)) {
      if ("smart" == r && (u = o.mode.indent(i, s.text.slice(c.length), s.text), u == Fl || u > 150)) {
        if (!n) return;
        r = "prev"
      }
    } else u = 0, r = "not";
    "prev" == r ? u = t > o.first ? Ul(Qn(o, t - 1).text, null, l) : 0 : "add" == r ? u = a + e.options.indentUnit : "subtract" == r ? u = a - e.options.indentUnit : "number" == typeof r && (u = a + r), u = Math.max(0, u);
    var h = "",
      f = 0;
    if (e.options.indentWithTabs)
      for (var d = Math.floor(u / l); d; --d) f += l, h += "\t";
    if (f < u && (h += Di(u - f)), h != c) return Dr(o, h, Bo(t, 0), Bo(t, c.length), "+input"), s.stateAfter = null, !0;
  ...
  function Gr(e, t, r, n) {
    var i = t,
      o = t;
    return "number" == typeof t ? o = Qn(e, pe(e, t)) : i = ri(t), null == i ? null : (n(o, i) && e.cm && zt(e.cm, i, r), o)
  }

  function Ur(e, t) {
    for (var r = e.doc.sel.ranges, n = [], i = 0; i < r.length; i++) {
      for (var o = t(r[i]); n.length && Go(o.from, Hi(n).to) <= 0;) {
        var l = n.pop();
        if (Go(l.from, o.from) < 0) {
          o.from = l.from;
          break
        }
      }
  ...
  function Vr(e, t, r, n, i) {
    function o() {
      var t = s + r;
      return !(t < e.first || t >= e.first + e.size) && (s = t, c = Qn(e, t))
    }

    function l(e) {
      var t = (i ? po : go)(c, a, r, !0);
      if (null == t) {
        if (e || !o()) return !1;
        a = i ? (r < 0 ? lo : oo)(c) : r < 0 ? c.text.length : 0
      } else a = t;
      return !0
    }
    var s = t.line,
    ...
    if ("char" == n) l();
      ...
      for (var h = null, f = "group" == n, d = e.cm && e.cm.getHelper(t, "wordChars"), p = !0; !(r < 0) || l(!p); p = !1) {
    ...
    var m = De(e, Bo(s, a), t, u, !0);
    return Go(t, m) || (m.hitSide = !0), m
  }
  ...
  function jr(t, r, n, i) {
    e.defaults[t] = r, n && (nl[t] = i ? function (e, t, r) {
      r != il && n(e, t, r)
    } : n)
  }
  ...
  function _r(e, t, r, n, i) {
    ...
    if (e.cm && !e.cm.curOp) return Ot(e.cm, _r)(e, t, r, n, i);
    var o = new bl(e, i),
      l = Go(t, r);
    if (n && Ri(n, o, !1), l > 0 || 0 == l && o.clearWhenEmpty !== !1) return o;
    if (o.replacedWith && (o.collapsed = !0, o.widgetNode = Ki("span", [o.replacedWith], "CodeMirror-widget"), n.handleMouseEvents || o.widgetNode.setAttribute("cm-ignore-events", "true"), n.insertLeft && (o.widgetNode.insertLeft = !0)), o.collapsed) {
      if (yn(e, t.line, t, r, o) || t.line != r.line && yn(e, r.line, t, r, o)) throw new Error("Inserting collapsed marker partially overlapping an existing one");
      Ro = !0
    }
    o.addToHistory && ci(e, {
      from: t,
    ...
    if (e.iter(a, r.line + 1, function (e) {
        u && o.collapsed && !u.options.lineWrapping && bn(e) == u.display.maxLine && (s = !0), o.collapsed && a != t.line && ti(e, 0), rn(e, new Jr(o, a == t.line ? t.ch : null, a == r.line ? r.ch : null)), ++a
      }), o.collapsed && e.iter(t.line, r.line + 1, function (t) {
        Sn(e, t) && ti(t, 0)
      }), o.clearOnEnter && Dl(o, "beforeCursorEnter", function () {
        o.clear()
      }), o.readOnly && (Fo = !0, (e.history.done.length || e.history.undone.length) && e.clearHistory()), o.collapsed && (o.id = ++yl, o.atomic = !0), u) {
      if (s && (u.curOp.updateMaxLine = !0), o.collapsed) It(u, t.line, r.line + 1);
      else if (o.className || o.title || o.startStyle || o.endStyle || o.css)
        for (var c = t.line; c <= r.line; c++) zt(u, c, "text");
      o.atomic && We(u.doc), Ti(u, "markerAdded", u, o)
    }
    return o
  }
  ...
  function qr(e, t, r, n, i) {
    ...
    return $n(e, function (e) {
      s && (n.widgetNode = s.cloneNode(!0)), o.push(_r(e, ge(e, t), ge(e, r), n, i));
  ...
  function Zr(e, t) {
    for (var r = 0; r < t.length; r++) {
      var n = t[r],
        ...
        l = e.clipPos(i.to);
      if (Go(o, l)) {
        var s = _r(e, o, l, n.primary, n.primary.type);
  ...
  function Qr(e) {
    for (var t = 0; t < e.length; t++) {
      ...
      for (var i = 0; i < r.markers.length; i++) {
        var o = r.markers[i];
        Pi(n, o.doc) == -1 && (o.parent = null, r.markers.splice(i--, 1))
      }
    }
  }
    ...
    if (e)
      for (var n, i = 0; i < e.length; ++i) {
        ...
        if (s || o.from == t && "bookmark" == l.type && (!r || !o.marker.insertLeft)) {
          ...
          (n || (n = [])).push(new Jr(l, o.from, a ? null : o.to))
        }
      }
    return n
  }
    ...
    if (e)
      for (var n, i = 0; i < e.length; ++i) {
        ...
        if (s || o.from == t && "bookmark" == l.type && (!r || o.marker.insertLeft)) {
          ...
          (n || (n = [])).push(new Jr(l, a ? null : o.from - t, null == o.to ? null : o.to - t))
        }
      }
    return n
  }
  ...
  function ln(e, t) {
    ...
    var r = me(e, t.from.line) && Qn(e, t.from.line).markedSpans,
      n = me(e, t.to.line) && Qn(e, t.to.line).markedSpans;
    if (!r && !n) return null;
    var i = t.from.ch,
      o = t.to.ch,
      l = 0 == Go(t.from, t.to),
    ...
    s && (s = sn(s)), a && a != s && (a = sn(a));
    var p = [s];
    if (!u) {
      var g, v = t.text.length - 2;
      if (v > 0 && s)
        for (var h = 0; h < s.length; ++h) null == s[h].to && (g || (g = [])).push(new Jr(s[h].marker, null, null));
      for (var h = 0; h < v; ++h) p.push(g);
      p.push(a)
    }
    return p
  }
    ...
    if (e.iter(t.line, r.line + 1, function (e) {
        if (e.markedSpans)
          for (var t = 0; t < e.markedSpans.length; ++t) {
            ...
            !r.readOnly || n && Pi(n, r) != -1 || (n || (n = [])).push(r)
          }
      }), !n) return null;
    for (var i = [{
        from: t,
      ...
      for (var l = n[o], s = l.find(0), a = 0; a < i.length; ++a) {
        var u = i[a];
        if (!(Go(u.to, s.from) < 0 || Go(u.from, s.to) > 0)) {
          var c = [a, 1],
            h = Go(u.from, s.from),
            f = Go(u.to, s.to);
  ...
  function pn(e, t) {
    ...
    var n = e.find(),
      i = t.find(),
      o = Go(n.from, i.from) || fn(e) - fn(t);
    if (o) return -o;
    var l = Go(n.to, i.to) || dn(e) - dn(t);
    return l ? l : t.id - e.id
  }

  function gn(e, t) {
    var r, n = Ro && e.markedSpans;
    if (n)
      for (var i, o = 0; o < n.length; ++o) i = n[o], i.marker.collapsed && null == (t ? i.from : i.to) && (!r || pn(r, i.marker) < 0) && (r = i.marker);
    return r
  }
      ...
      for (var s = 0; s < l.length; ++s) {
        ...
        if (a.marker.collapsed) {
          var u = a.marker.find(0),
            c = Go(u.from, r) || fn(a.marker) - fn(i),
            h = Go(u.to, n) || dn(a.marker) - dn(i);
          if (!(c >= 0 && h <= 0 || c <= 0 && h >= 0) && (c <= 0 && (a.marker.inclusiveRight && i.inclusiveLeft ? Go(u.to, r) >= 0 : Go(u.to, r) > 0) || c >= 0 && (a.marker.inclusiveRight && i.inclusiveLeft ? Go(u.from, n) <= 0 : Go(u.from, n) < 0))) return !0
        }
      }
  }
  ...
  function Sn(e, t) {
    var r = Ro && t.markedSpans;
    if (r)
      for (var n, i = 0; i < r.length; ++i)
        if (n = r[i], n.marker.collapsed) {
          if (null == n.from) return !0;
          if (!n.marker.widgetNode && 0 == n.from && n.marker.inclusiveLeft && Ln(e, t, n)) return !0
        }
  }
  ...
  function Ln(e, t, r) {
    if (null == r.to) {
      ...
      return Ln(e, n.line, en(n.line.markedSpans, r.marker))
    }
    if (r.marker.inclusiveRight && r.to == t.text.length) return !0;
    for (var i, o = 0; o < t.markedSpans.length; ++o)
      if (i = t.markedSpans[o], i.marker.collapsed && !i.marker.widgetNode && i.from == r.to && (null == i.to || i.to != r.from) && (i.marker.inclusiveLeft || r.marker.inclusiveRight) && Ln(e, t, i)) return !0
  }

  function Tn(e, t, r) {
    ii(t) < (e.curOp && e.curOp.scrollTop || e.doc.scrollTop) && zr(e, null, r)
  }
  ...
  function kn(e) {
    ...
    if (!$l(document.body, e.node)) {
      ...
      e.coverGutter && (r += "margin-left: -" + t.display.gutters.offsetWidth + "px;"), e.noHScroll && (r += "width: " + t.display.wrapper.clientWidth + "px;"), Xi(t.display.measure, Ki("div", [e.node], null, r))
    }
  ...
  function Mn(e, t, r, n) {
    var i = new xl(e, r, n),
      o = e.cm;
    return o && i.noHScroll && (o.display.alignWidgets = !0), Gr(e, t, "widget", function (t) {
      var r = t.widgets || (t.widgets = []);
      if (null == i.insertAt ? r.push(i) : r.splice(Math.min(r.length - 1, Math.max(0, i.insertAt)), 0, i), i.line = t, o && !Sn(e, t)) {
        var n = ii(t) < e.scrollTop;
        ti(t, t.height + kn(i)), n && zr(o, null, i.height), o.curOp.forceUpdate = !0
      }
      return !0
    }), i
  }
  ...
  function Nn(e, t, r, n) {
    e.text = t, e.stateAfter && (e.stateAfter = null), e.styles && (e.styles = null), null != e.order && (e.order = null), cn(e), hn(e, r);
    var i = n ? n(e) : 1;
    i != e.height && ti(e, i)
  }
  ...
  function Hn(e, t, r, n) {
    ...
    var a, u = Qn(l, t.line),
      c = Ue(e, t.line, r),
      h = new ml(u.text, e.options.tabSize);
    for (n && (a = []);
      (n || h.pos < t.ch) && !h.eol();) h.start = h.pos, o = Dn(s, h, c), n && a.push(i(!0));
    return n ? a : i()
  }

  function Pn(e, t, r, n, i, o, l) {
    var s = r.flattenSpans;
    null == s && (s = e.options.flattenSpans);
    var a, u = 0,
      c = null,
      h = new ml(t, e.options.tabSize),
      f = e.options.addModeClass && [null];
    for ("" == t && An(On(r, n), o); !h.eol();) {
      if (h.pos > e.options.maxHighlightLength ? (s = !1, l && zn(e, t, n, h.pos), h.pos = t.length, a = null) : a = An(Dn(r, h, n, f), o), f) {
        var d = f[0].name;
        d && (a = "m-" + (a ? d + " " + a : d))
      }
      if (!s || c != a) {
  ...
  function En(e, t, r, n) {
    var i = [e.state.modeGen],
      o = {};
    Pn(e, t.text, e.doc.mode, r, function (e, t) {
      i.push(e, t)
    }, o, n);
    for (var l = 0; l < e.state.overlays.length; ++l) {
      var s = e.state.overlays[l],
        a = 1,
        u = 0;
      Pn(e, t.text, s.mode, !0, function (e, t) {
        for (var r = a; u < e;) {
          var n = i[a];
  ...
  function In(e, t, r) {
    if (!t.styles || t.styles[0] != e.state.modeGen) {
      var n = Ue(e, ri(t)),
        i = En(e, t, t.text.length > e.options.maxHighlightLength ? cl(e.doc.mode, n) : n);
  ...
  function zn(e, t, r, n) {
    var i = e.doc.mode,
      o = new ml(t, e.options.tabSize);
    for (o.start = o.pos = n || 0, "" == t && On(i, r); !o.eol();) Dn(i, o, r), o.start = o.pos
  }
  ...
  function Rn(e, t) {
    var r = Ki("span", null, null, So ? "padding-right: .1px" : null),
      n = {
        ...
        cm: e,
        trailingSpace: !1,
        splitSpaces: (xo || So) && e.getOption("lineWrapping")
      };
    t.measure = {};
    for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
      var o, l = i ? t.rest[i - 1] : t.line;
      n.pos = 0, n.addToken = Gn, eo(e.display.measure) && (o = oi(l)) && (n.addToken = Vn(n.addToken, o)), n.map = [];
      var s = t != e.display.externalMeasured && ri(l);
      jn(l, n, In(e, l, s)), l.styleClasses && (l.styleClasses.bgClass && (n.bgClass = qi(l.styleClasses.bgClass, n.bgClass || "")), l.styleClasses.textClass && (n.textClass = qi(l.styleClasses.textClass, n.textClass || ""))), 0 == n.map.length && n.map.push(0, 0, n.content.appendChild(Ji(e.display.measure))), 0 == i ? (t.measure.map = n.map, t.measure.cache = {}) : ((t.measure.maps || (t.measure.maps = [])).push(n.map), (t.measure.caches || (t.measure.caches = [])).push({}))
    }
    if (So) {
    ...
    return El(e, "renderLine", e, t.line, n.pre), n.pre.className && (n.textClass = qi(n.pre.className, n.textClass || "")), n
  }
  ...
  function Gn(e, t, r, n, i, o, l) {
    if (t) {
      var s = e.splitSpaces ? Un(t, e.trailingSpace) : t,
      ...
      if (a.test(t))
        for (var c = document.createDocumentFragment(), h = 0;;) {
          ...
          if (d) {
            ...
            xo && Co < 9 ? c.appendChild(Ki("span", [p])) : c.appendChild(p), e.map.push(e.pos, e.pos + d, p), e.col += d, e.pos += d
          }
          if (!f) break;
          if (h += d + 1, "\t" == f[0]) {
            var g = e.cm.options.tabSize,
              v = g - e.col % g,
              p = c.appendChild(Ki("span", Di(v), "cm-tab"));
            p.setAttribute("role", "presentation"), p.setAttribute("cm-text", "\t"), e.col += v
          } else if ("\r" == f[0] || "\n" == f[0]) {
            var p = c.appendChild(Ki("span", "\r" == f[0] ? "␍" : "␤", "cm-invalidchar"));
            p.setAttribute("cm-text", f[0]), e.col += 1
          } else {
            var p = e.cm.options.specialCharPlaceholder(f[0]);
            p.setAttribute("cm-text", f[0]), xo && Co < 9 ? c.appendChild(Ki("span", [p])) : c.appendChild(p), e.col += 1
          }
          e.map.push(e.pos, e.pos + 1, p), e.pos++
        } else {
          e.col += t.length;
          var c = document.createTextNode(s);
          e.map.push(e.pos, e.pos + t.length, c), xo && Co < 9 && (u = !0), e.pos += t.length
        }
      if (e.trailingSpace = 32 == s.charCodeAt(t.length - 1), r || n || i || u || l) {
        var m = r || "";
        n && (m += n), i && (m += i);
        var y = Ki("span", [c], m, l);
      ...
      for (var l, s, a, u, c, h, f, d = i.length, p = 0, g = 1, v = "", m = 0;;) {
        if (m == p) {
          ...
          for (var y, b = [], w = 0; w < n.length; ++w) {
            var x = n[w],
              C = x.marker;
            "bookmark" == C.type && x.from == p && C.widgetNode ? b.push(C) : x.from <= p && (null == x.to || x.to > p || C.collapsed && x.to == p && x.from == p) ? (null != x.to && x.to != p && m > x.to && (m = x.to, u = ""), C.className && (a += " " + C.className), C.css && (s = (s ? s + ";" : "") + C.css), C.startStyle && x.from == p && (c += " " + C.startStyle), C.endStyle && x.to == m && (y || (y = [])).push(C.endStyle, x.to), C.title && !h && (h = C.title), C.collapsed && (!f || pn(f.marker, C) < 0) && (f = x)) : x.from > p && m > x.from && (m = x.from)
          }
          if (y)
            for (var w = 0; w < y.length; w += 2) y[w + 1] == m && (u += " " + y[w]);
          if (!f || f.from == p)
            for (var w = 0; w < b.length; ++w) Kn(t, 0, b[w]);
          if (f && (f.from || 0) == p) {
            if (Kn(t, (null == f.to ? d + 1 : f.to) - p, f.marker, null == f.from), null == f.to) return;
            f.to == p && (f = !1)
          }
        }
        if (p >= d) break;
        for (var S = Math.min(d, m);;) {
          ...
          v = i.slice(o, o = r[g++]), l = Fn(r[g++], t.cm.options)
        }
      } else
        for (var g = 1; g < r.length; g += 2) t.addToken(t, i.slice(o, o = r[g]), Fn(r[g + 1], t.cm.options))
  }
  ...
  function Yn(e, t, r, n) {
    ...
    function o(e, r, i) {
      Nn(e, r, i, n), Ti(e, "change", e, t)
    }

    function l(e, t) {
      for (var r = e, o = []; r < t; ++r) o.push(new Cl(u[r], i(r), n));
      return o
    }
    var s = t.from,
      a = t.to,
    ...
    if (t.full) e.insert(0, l(0, u.length)), e.remove(u.length, e.size - u.length);
      ...
      if (1 == u.length) o(c, c.text.slice(0, s.ch) + f + c.text.slice(a.ch), d);
        ...
        g.push(new Cl(f + c.text.slice(a.ch), d, n)), o(c, c.text.slice(0, s.ch) + u[0], i(0)), e.insert(s.line + 1, g)
      }
  ...
  function Zn(e, t) {
    ...
    e.doc = t, t.cm = e, l(e), r(e), e.options.lineWrapping || f(e), e.options.mode = t.modeOption, It(e)
  }
  ...
  function ri(e) {
    ...
    for (var t = e.parent, r = Pi(t.lines, e), n = t.parent; n; t = n, n = n.parent)
  ...
  function si(e, t) {
    ...
    return pi(e, r, t.from.line, t.to.line + 1), $n(e, function (e) {
  ...
  function ui(e, t) {
    return t ? (ai(e.done), Hi(e.done)) : e.done.length && !Hi(e.done).ranges ? Hi(e.done) : e.done.length > 1 && !e.done[e.done.length - 2].ranges ? (e.done.pop(), Hi(e.done)) : void 0
  }
  ...
  function ci(e, t, r, n) {
    ...
    i.undone.length = 0;
    var o, l = +new Date;
    if ((i.lastOp == n || i.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && e.cm && i.lastModTime > l - e.cm.options.historyEventDelay || "*" == t.origin.charAt(0))) && (o = ui(i, i.lastOp == n))) {
      var s = Hi(o.changes);
      0 == Go(t.from, t.to) && 0 == Go(t.from, s.to) ? s.to = tl(t) : o.changes.push(si(e, t))
    } else {
      var a = Hi(i.done);
      for (a && a.ranges || di(e.sel, i.done), o = {
          changes: [si(e, t)],
          generation: i.generation
        }, i.done.push(o); i.done.length > i.undoDepth;) i.done.shift(), i.done[0].ranges || i.done.shift()
    }
    i.done.push(r), i.generation = ++i.maxGeneration, i.lastModTime = i.lastSelTime = l, i.lastOp = i.lastSelOp = n, i.lastOrigin = i.lastSelOrigin = t.origin, s || El(e, "historyAdded")
  }
  ...
  function fi(e, t, r, n) {
    var i = e.history,
      o = n && n.origin;
    r == i.lastSelOp || o && i.lastSelOrigin == o && (i.lastModTime == i.lastSelTime && i.lastOrigin == o || hi(e, o, Hi(i.done), t)) ? i.done[i.done.length - 1] = t : di(t, i.done), i.lastSelTime = +new Date, i.lastSelOrigin = o, i.lastSelOp = r, n && n.clearRedo !== !1 && ai(i.undone)
  }
      ...
      if (o.ranges) i.push(r ? ce.prototype.deepCopy.call(o) : o);
        ...
        for (var a = 0; a < l.length; ++a) {
          ...
          if (s.push({
            ...
            for (var h in c)(u = h.match(/^spans_(\d+)$/)) && Pi(t, Number(u[1])) > -1 && (Hi(s)[h] = c[h], delete c[h])
        }
      }
    }
    return i
  ...
  function bi(e, t, r, n) {
    for (var i = 0; i < e.length; ++i) {
      ...
      if (o.ranges) {
        ...
        for (var s = 0; s < o.ranges.length; s++) yi(o.ranges[s].anchor, t, r, n), yi(o.ranges[s].head, t, r, n)
      } else {
  ...
  function Si(e) {
    var t = e.which;
    return null == t && (1 & e.button ? t = 1 : 2 & e.button ? t = 3 : 4 & e.button && (t = 2)), Do && e.ctrlKey && 1 == t && (t = 3), t
  }

  function Li(e, t, r) {
    var n = e._handlers && e._handlers[t];
    return r ? n && n.length > 0 ? n.slice() : Hl : n || Hl
  }
  ...
  function Ti(e, t) {
    ...
    if (n.length) {
      ...
      Yo ? i = Yo.delayedCallbacks : Il ? i = Il : (i = Il = [], setTimeout(ki, 0));
  ...
  function Mi(e, t, r) {
    ...
    }), El(e, r || t.type, e, t), xi(t) || t.codemirrorIgnore
  }

  function Ni(e) {
    var t = e._handlers && e._handlers.cursorActivity;
    if (t)
      for (var r = e.curOp.cursorActivityHandlers || (e.curOp.cursorActivityHandlers = []), n = 0; n < t.length; ++n) Pi(r, t[n]) == -1 && r.push(t[n])
  }

  function Wi(e, t) {
    return Li(e, t).length > 0
  }
  ...
  function Fi(e, t) {
    var r;
    return Object.create ? r = Object.create(e) : (zi.prototype = e, r = new zi), t && Ri(t, r), r
  }
  ...
  function Gi(e, t) {
    return t ? !!(t.source.indexOf("\\w") > -1 && _l(e)) || t.test(e) : _l(e)
  }
  ...
  function qi(e, t) {
    for (var r = e.split(" "), n = 0; n < r.length; n++) r[n] && !_i(r[n]).test(t) && (t += " " + r[n]);
    return t
  }
  ...
  function Ji(e) {
    if (null == Zl) {
      var t = Ki("span", "​");
      Xi(e, Ki("span", [t, document.createTextNode("x")])), 0 != e.firstChild.offsetHeight && (Zl = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(xo && Co < 8))
    }
    var r = Zl ? Ki("span", "​") : Ki("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px");
    return r.setAttribute("cm-text", ""), r
  }

  function eo(e) {
    if (null != Ql) return Ql;
    var t = Xi(e, document.createTextNode("AخA")),
      r = Xl(t, 0, 1).getBoundingClientRect(),
      n = Xl(t, 1, 2).getBoundingClientRect();
    return ji(e), !(!r || r.left == r.right) && (Ql = n.right - r.right < 3)
  }

  function to(e) {
    if (null != ls) return ls;
    var t = Xi(e, Ki("span", "x")),
      r = t.getBoundingClientRect(),
      n = Xl(t, 0, 1).getBoundingClientRect();
    return ls = Math.abs(r.left - n.left) > 1
  }
  ...
  function lo(e) {
    var t = oi(e);
    return t ? io(Hi(t)) : e.text.length
  }
  ...
  function so(e, t) {
    ...
    n != r && (t = ri(n));
    var i = oi(n),
      o = i ? i[0].level % 2 ? lo(n) : oo(n) : 0;
    return Bo(t, o)
  }

  function ao(e, t) {
    for (var r, n = Qn(e.doc, t); r = mn(n);) n = r.find(1, !0).line, t = null;
    var i = oi(n),
      o = i ? i[0].level % 2 ? oo(n) : lo(n) : n.text.length;
    return Bo(null == t ? ri(n) : t, o)
  }
  ...
  function ho(e, t) {
    ...
    for (var r, n = 0; n < e.length; ++n) {
      ...
      if (i.from == t || i.to == t) {
        if (null != r) return co(e, i.level, e[r].level) ? (i.from != i.to && (as = r), n) : (i.from != i.to && (as = n), r);
        r = n
      }
    }
    return r
  ...
  function fo(e, t, r, n) {
    if (!n) return t + r;
    do t += r; while (t > 0 && Vi(e.text.charAt(t)));
    return t
  }
  ...
  function po(e, t, r, n) {
    ...
    for (var o = ho(i, t), l = i[o], s = fo(e, t, l.level % 2 ? -r : r, n);;) {
      if (s > l.from && s < l.to) return s;
      if (s == l.from || s == l.to) return ho(i, s) == o ? s : (l = i[o += r], r > 0 == l.level % 2 ? l.to : l.from);
      if (l = i[o += r], !l) return null;
      s = r > 0 == l.level % 2 ? fo(e, l.to, -1, n) : fo(e, l.from, 1, n)
    }
  }
  ...
  function go(e, t, r, n) {
    var i = t + r;
    if (n)
      for (; i > 0 && Vi(e.text.charAt(i));) i += r;
    return i < 0 || i > e.text.length ? null : i
  }
  var vo = navigator.userAgent,
    mo = navigator.platform,
    yo = /gecko\/\d/i.test(vo),
    bo = /MSIE \d/.test(vo),
    wo = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(vo),
    xo = bo || wo,
    Co = xo && (bo ? document.documentMode || 6 : wo[1]),
    So = /WebKit\//.test(vo),
    Lo = So && /Qt\/\d+\.\d+/.test(vo),
    To = /Chrome\//.test(vo),
    ko = /Opera\//.test(vo),
    Mo = /Apple Computer/.test(navigator.vendor),
    No = /Mac OS X 1\d\D([8-9]|\d\d)\D/.test(vo),
    Wo = /PhantomJS/.test(vo),
    Ao = /AppleWebKit/.test(vo) && /Mobile\/\w+/.test(vo),
    Oo = Ao || /Android|webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(vo),
    Do = Ao || /Mac/.test(mo),
    Ho = /\bCrOS\b/.test(vo),
    Po = /win/i.test(mo),
    Eo = ko && vo.match(/Version\/(\d*\.\d*)/);
  Eo && (Eo = Number(Eo[1])), Eo && Eo >= 15 && (ko = !1, So = !0);
  var Io = Do && (Lo || ko && (null == Eo || Eo < 12.11)),
    zo = yo || xo && Co >= 9,
    Fo = !1,
    Ro = !1;
  g.prototype = Ri({
    ...
    Wi(e, t) && this.events.push(arguments)
  }, T.prototype.finish = function () {
    for (var e = 0; e < this.events.length; e++) El.apply(null, this.events[e])
  };
  var Bo = e.Pos = function (e, t) {
      return this instanceof Bo ? (this.line = e, void(this.ch = t)) : new Bo(e, t)
    },
    Go = e.cmpPos = function (e, t) {
  ...
  re.prototype = Ri({
    init: function (e) {
      function t(e) {
        if (!Mi(n, e)) {
          if (n.somethingSelected()) Uo = {
            lineWise: !1,
            text: n.getSelections()
          }, r.inaccurateSelection && (r.prevInput = "", r.inaccurateSelection = !1, o.value = Uo.text.join("\n"), jl(o));
          else {
            ...
            Uo = {
              lineWise: !0,
              text: t.text
            }, "cut" == e.type ? n.setSelections(t.ranges, null, Rl) : (r.prevInput = "", o.value = t.text.join("\n"), jl(o))
          }
      ...
      e.wrapper.insertBefore(i, e.wrapper.firstChild), Ao && (o.style.width = "0px"), Dl(o, "input", function () {
        xo && Co >= 9 && r.hasSelection && (r.hasSelection = null), r.poll()
      }), Dl(o, "paste", function (e) {
        Mi(n, e) || Q(e, n) || (n.state.pasteIncoming = !0, r.fastPoll())
      }), Dl(o, "cut", t), Dl(o, "copy", t), Dl(e.scroller, "paste", function (t) {
        Xt(e, t) || Mi(n, t) || (n.state.pasteIncoming = !0, r.focus())
      }), Dl(e.lineSpace, "selectstart", function (t) {
        Xt(e, t) || Wl(t)
      }), Dl(o, "compositionstart", function () {
    ...
    prepareSelection: function () {
      ...
      if (e.options.moveInputWithCursor) {
        var i = pt(e, r.sel.primary().head, "div"),
    ...
    showSelection: function (e) {
      var t = this.cm,
        r = t.display;
      Xi(r.cursorDiv, e.cursors), Xi(r.selectionDiv, e.selection), null != e.teTop && (this.wrapper.style.top = e.teTop + "px", this.wrapper.style.left = e.teLeft + "px")
    },
    reset: function (e) {
      if (!this.contextMenuPending) {
        ...
        if (n.somethingSelected()) {
          ...
          this.textarea.value = l, n.state.focused && jl(this.textarea), xo && Co >= 9 && (this.hasSelection = l)
        } else e || (this.prevInput = this.textarea.value = "", xo && Co >= 9 && (this.hasSelection = null));
    ...
    focus: function () {
      if ("nocursor" != this.cm.options.readOnly && (!Oo || Yi() != this.textarea)) try {
        this.textarea.focus()
      } catch (e) {}
    },
    blur: function () {
    ...
    poll: function () {
      ...
      for (var o = 0, l = Math.min(r.length, n.length); o < l && r.charCodeAt(o) == n.charCodeAt(o);) ++o;
      var s = this;
    ...
    onKeyPress: function () {
      xo && Co >= 9 && (this.hasSelection = null), this.fastPoll()
    },
    onContextMenu: function (e) {
      ...
      function r() {
        if (n.contextMenuPending = !1, n.wrapper.style.cssText = h, l.style.cssText = c, xo && Co < 9 && o.scrollbars.setScrollTop(o.scroller.scrollTop = a), null != l.selectionStart) {
          (!xo || xo && Co < 9) && t();
          var e = 0,
            r = function () {
              o.selForContextMenu == i.doc.sel && 0 == l.selectionStart && l.selectionEnd > 0 && "​" == n.prevInput ? Ot(i, fl.selectAll)(i) : e++ < 10 ? o.detectingSelectAll = setTimeout(r, 500) : o.input.reset()
            };
      ...
      if (s && !ko) {
        ...
        u && i.doc.sel.contains(s) == -1 && Ot(i, ke)(i.doc, de(s), Rl);
        var c = l.style.cssText,
          h = n.wrapper.style.cssText;
        n.wrapper.style.cssText = "position: absolute";
        var f = n.wrapper.getBoundingClientRect();
        if (l.style.cssText = "position: absolute; width: 30px; height: 30px; top: " + (e.clientY - f.top - 5) + "px; left: " + (e.clientX - f.left - 5) + "px; z-index: 1000; background: " + (xo ? "rgba(255, 255, 255, .05)" : "transparent") + "; outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);", So) var d = window.scrollY;
        if (o.input.focus(), So && window.scrollTo(null, d), o.input.reset(), i.somethingSelected() || (l.value = n.prevInput = " "), n.contextMenuPending = !0, o.selForContextMenu = i.doc.sel, clearTimeout(o.detectingSelectAll), xo && Co >= 9 && t(), zo) {
          Ol(e);
          var p = function () {
            Pl(window, "mouseup", p), setTimeout(r, 20)
          };
          Dl(window, "mouseup", p)
    ...
    init: function (e) {
        ...
        if (!Mi(n, e)) {
          if (n.somethingSelected()) Uo = {
            ...
            Uo = {
              ...
              n.setSelections(t.ranges, 0, Rl), n.replaceSelection("", null, "cut")
            })
          }
          if (e.clipboardData) {
          ...
          var l = ne(),
            s = l.firstChild;
          n.display.lineSpace.insertBefore(l, n.display.lineSpace.firstChild), s.value = Uo.text.join("\n");
          var a = document.activeElement;
          jl(s), setTimeout(function () {
      ...
      var r = this,
        n = r.cm,
        i = r.div = e.lineDiv;
      te(i, n.options.spellcheck), Dl(i, "paste", function (e) {
        Mi(n, e) || Q(e, n) || Co <= 11 && setTimeout(Ot(n, function () {
          r.pollContent() || It(n)
        }), 20)
      }), Dl(i, "compositionstart", function (e) {
        var t = e.data;
        if (r.composing = {
            sel: n.doc.sel,
            data: t,
          ...
          l > -1 && l <= i.head.ch && (r.composing.sel = de(Bo(i.head.line, l), Bo(i.head.line, l + t.length)))
        }
      }), Dl(i, "compositionupdate", function (e) {
        r.composing.data = e.data
      }), Dl(i, "compositionend", function (e) {
        var t = r.composing;
      ...
      }), Dl(i, "touchstart", function () {
        r.forceCompositionEnd()
      }), Dl(i, "input", function () {
        r.composing || !n.isReadOnly() && r.pollContent() || At(r.cm, function () {
          It(n)
        })
      }), Dl(i, "copy", t), Dl(i, "cut", t)
    },
    prepareSelection: function () {
      var e = Ee(this.cm, !1);
    ...
    showPrimarySelection: function () {
      ...
      if (!r || r.bad || !n || n.bad || 0 != Go(q(r, n), t.from()) || 0 != Go(_(r, n), t.to())) {
        ...
        if (i || o) {
          ...
          try {
            var c = Xl(i.node, i.offset, o.offset, o.node)
          } catch (e) {}
          c && (!yo && this.cm.state.focused ? (e.collapse(i.node, i.offset), c.collapsed || e.addRange(c)) : (e.removeAllRanges(), e.addRange(c)), s && null == e.anchorNode ? e.addRange(s) : yo && this.startGracePeriod()), this.rememberSelection()
        }
      }
    },
    ...
    showMultipleSelections: function (e) {
      Xi(this.cm.display.cursorDiv, e.cursors), Xi(this.cm.display.selectionDiv, e.selection)
    },
    ...
    pollSelection: function () {
      if (!this.composing && !this.gracePeriod && this.selectionChanged()) {
        ...
        r && n && At(t, function () {
          ke(t.doc, de(r, n), Rl), (r.bad || n.bad) && (t.curOp.selectionChanged = !0)
        })
      }
    },
    pollContent: function () {
      ...
      var o;
      if (n.line == t.viewFrom || 0 == (o = Rt(e, n.line))) var l = ri(t.view[0].line),
        s = t.view[0].node;
      else var l = ri(t.view[o].line),
        s = t.view[o - 1].node.nextSibling;
      var a = Rt(e, i.line);
      if (a == t.view.length - 1) var u = t.viewTo - 1,
        c = t.lineDiv.lastChild;
      else var u = ri(t.view[a + 1].line) - 1,
        c = t.view[a + 1].node.previousSibling;
      for (var h = e.doc.splitLines(ue(e, s, c, l, u)), f = Jn(e.doc, Bo(l, 0), Bo(u, Qn(e.doc, u).text.length)); h.length > 1 && f.length > 1;)
        if (Hi(h) == Hi(f)) h.pop(), f.pop(), u--;
        else {
          if (h[0] != f[0]) break;
          h.shift(), f.shift(), l++
        } for (var d = 0, p = 0, g = h[0], v = f[0], m = Math.min(g.length, v.length); d < m && g.charCodeAt(d) == v.charCodeAt(d);) ++d;
      for (var y = Hi(h), b = Hi(f), w = Math.min(y.length - (1 == h.length ? d : 0), b.length - (1 == f.length ? d : 0)); p < w && y.charCodeAt(y.length - p - 1) == b.charCodeAt(b.length - p - 1);) ++p;
      h[h.length - 1] = y.slice(0, y.length - p), h[0] = h[0].slice(d);
      var x = Bo(l, d),
        C = Bo(u, f.length ? Hi(f).length - p : 0);
      return h.length > 1 || h[0] || Go(x, C) ? (Dr(e.doc, h, x, C, "+input"), !0) : void 0
    },
    ensurePolled: function () {
    ...
    applyComposition: function (e) {
      this.cm.isReadOnly() ? Ot(this.cm, It)(this.cm) : e.data && e.data != e.startData && Ot(this.cm, Z)(this.cm, e.data, 0, e.sel)
    },
    ...
    equals: function (e) {
      ...
      for (var t = 0; t < this.ranges.length; t++) {
        var r = this.ranges[t],
          n = e.ranges[t];
        if (0 != Go(r.anchor, n.anchor) || 0 != Go(r.head, n.head)) return !1
      }
      return !0
    },
    deepCopy: function () {
    ...
    contains: function (e, t) {
      ...
      for (var r = 0; r < this.ranges.length; r++) {
        var n = this.ranges[r];
        if (Go(t, n.from()) >= 0 && Go(e, n.to()) <= 0) return r
      }
      return -1
    }
  }, he.prototype = {
  ...
  var Vo, Ko, jo, Xo = {
    ...
    $o = 0,
    Zo = null;
  xo ? Zo = -.53 : yo ? Zo = 15 : To ? Zo = -.7 : Mo && (Zo = -1 / 3);
  var Qo = function (e) {
    var t = e.wheelDeltaX,
      r = e.wheelDeltaY;
  ...
  var Jo = new Oi,
    el = null,
    tl = e.changeEnd = function (e) {
      return e.text ? Bo(e.from.line + e.text.length - 1, Hi(e.text).length + (1 == e.text.length ? e.from.ch : 0)) : e.to
    };
  e.prototype = {
    constructor: e,
    focus: function () {
    ...
    setOption: function (e, t) {
      var r = this.options,
        n = r[e];
      r[e] == t && "mode" != e || (r[e] = t, nl.hasOwnProperty(e) && Ot(this, nl[e])(this, t, n))
    },
    ...
    addKeyMap: function (e, t) {
      this.state.keyMaps[t ? "push" : "unshift"](Yr(e))
    },
    ...
    addOverlay: Dt(function (t, r) {
      ...
      Ii(this.state.overlays, {
        ...
        return e.priority
      }), this.state.modeGen++, It(this)
    }),
    removeOverlay: Dt(function (e) {
      for (var t = this.state.overlays, r = 0; r < t.length; ++r) {
        var n = t[r].modeSpec;
        if (n == e || "string" == typeof e && n.name == e) return t.splice(r, 1), this.state.modeGen++, void It(this)
      }
    }),
    indentLine: Dt(function (e, t, r) {
      "string" != typeof t && "number" != typeof t && (t = null == t ? this.options.smartIndent ? "smart" : "prev" : t ? "add" : "subtract"), me(this.doc, e) && Br(this, e, t, r)
    }),
    indentSelection: Dt(function (e) {
      for (var t = this.doc.sel.ranges, r = -1, n = 0; n < t.length; n++) {
        var i = t[n];
        if (i.empty()) i.head.line > r && (Br(this, i.head.line, e, !0), r = i.head.line, n == this.doc.sel.primIndex && Fr(this));
        else {
          var o = i.from(),
            l = i.to(),
            s = Math.max(r, o.line);
          ...
          0 == o.ch && t.length == u.length && u[n].from().ch > 0 && Ce(this.doc, n, new he(o, u[n].to()), Rl)
        }
      }
    }),
    ...
    getLineTokens: function (e, t) {
      return Hn(this, Bo(e), t, !0)
    },
    getTokenTypeAt: function (e) {
      e = ge(this.doc, e);
      var t, r = In(this, Qn(this.doc, e.line)),
        n = 0,
        i = (r.length - 1) / 2,
        o = e.ch;
      if (0 == o) t = r[2];
    ...
    getHelpers: function (e, t) {
      var r = [];
      if (!ul.hasOwnProperty(t)) return r;
      var n = ul[t],
        i = this.getModeAt(e);
      ...
      for (var o = 0; o < n._global.length; o++) {
        var s = n._global[o];
        s.pred(i, this) && Pi(r, s.val) == -1 && r.push(s.val)
      }
      return r
    },
    ...
    cursorCoords: function (e, t) {
      ...
      return r = null == e ? n.head : "object" == typeof e ? ge(this.doc, e) : e ? n.from() : n.to(), pt(this, r, t || "page")
    },
    charCoords: function (e, t) {
      return dt(this, ge(this.doc, e), t || "page")
    },
    coordsChar: function (e, t) {
      return e = ft(this, e, t || "page"), mt(this, e.left, e.top)
    },
    ...
    heightAtLine: function (e, t) {
      ...
      if ("number" == typeof e) {
        ...
        e < this.doc.first ? e = this.doc.first : e > i && (e = i, n = !0), r = Qn(this.doc, e)
      } else r = e;
      return ht(this, r, {
        top: 0,
        left: 0
      }, t || "page").top + (n ? this.doc.height - ii(r) : 0)
    },
    ...
    setGutterMarker: Dt(function (e, t, r) {
      return Gr(this.doc, e, "gutter", function (e) {
        var n = e.gutterMarkers || (e.gutterMarkers = {});
        return n[t] = r, !r && Ui(n) && (e.gutterMarkers = null), !0
      })
    }),
    clearGutter: Dt(function (e) {
      var t = this,
        ...
        n = r.first;
      r.iter(function (r) {
        r.gutterMarkers && r.gutterMarkers[e] && (r.gutterMarkers[e] = null, zt(t, n, "gutter"), Ui(r.gutterMarkers) && (r.gutterMarkers = null)), ++n
      })
    }),
    lineInfo: function (e) {
      if ("number" == typeof e) {
        ...
        var t = e;
        if (e = Qn(this.doc, e), !e) return null
      } else {
        var t = ri(e);
    ...
    addWidget: function (e, t, r, n, i) {
      ...
      t.style.top = l + "px", t.style.left = t.style.right = "", "right" == i ? (s = o.sizer.clientWidth - t.offsetWidth, t.style.right = "0px") : ("left" == i ? s = 0 : "middle" == i && (s = (o.sizer.clientWidth - t.offsetWidth) / 2), t.style.left = s + "px"), r && Er(this, s, l, s + t.offsetWidth, l + t.offsetHeight)
    },
    triggerOnKeyDown: Dt(fr),
    triggerOnKeyPress: Dt(gr),
    triggerOnKeyUp: pr,
    execCommand: function (e) {
      if (fl.hasOwnProperty(e)) return fl[e].call(null, this)
    },
    ...
    findPosH: function (e, t, r, n) {
      var i = 1;
      t < 0 && (i = -1, t = -t);
      for (var o = 0, l = ge(this.doc, e); o < t && (l = Vr(this.doc, l, i, r, n), !l.hitSide); ++o);
      return l
    },
    moveH: Dt(function (e, t) {
      var r = this;
      r.extendSelectionsBy(function (n) {
        return r.display.shift || r.doc.extend || n.empty() ? Vr(r.doc, n.head, e, t, r.options.rtlMoveVisually) : e < 0 ? n.from() : n.to()
      }, Gl)
    }),
    deleteH: Dt(function (e, t) {
      var r = this.doc.sel,
        n = this.doc;
      r.somethingSelected() ? n.replaceSelection("", null, "+delete") : Ur(this, function (r) {
        var i = Vr(n, r.head, e, t, !1);
        return e < 0 ? {
          from: i,
          to: r.head
        } : {
    ...
    findPosV: function (e, t, r, n) {
      var i = 1,
        o = n;
      t < 0 && (i = -1, t = -t);
      for (var l = 0, s = ge(this.doc, e); l < t; ++l) {
        var a = pt(this, s, "div");
        if (null == o ? o = a.left : a.left = o, s = Kr(this, a, i, r), s.hitSide) break
      }
      return s
    },
    moveV: Dt(function (e, t) {
      ...
      if (n.extendSelectionsBy(function (l) {
          ...
          var a = Kr(r, s, e, t);
          return "page" == t && l == n.sel.primary() && zr(r, null, dt(r, a, "div").top - s.top), a
        }, Gl), i.length)
    ...
    findWordAt: function (e) {
      ...
      if (r) {
        ...
        for (var l = r.charAt(n), s = Gi(l, o) ? function (e) {
            return Gi(e, o)
          } : /\s/.test(l) ? function (e) {
            return /\s/.test(e)
          } : function (e) {
            return !/\s/.test(e) && !Gi(e)
          }; n > 0 && s(r.charAt(n - 1));) --n;
        for (; i < r.length && s(r.charAt(i));) ++i
      }
      return new he(Bo(e.line, n), Bo(e.line, i))
    },
    toggleOverwrite: function (e) {
      null != e && e == this.state.overwrite || ((this.state.overwrite = !this.state.overwrite) ? es(this.display.cursorDiv, "CodeMirror-overwrite") : Jl(this.display.cursorDiv, "CodeMirror-overwrite"), El(this, "overwriteToggle", this, this.state.overwrite))
    },
    hasFocus: function () {
      return this.display.input.getField() == Yi()
    },
    isReadOnly: function () {
      return !(!this.options.readOnly && !this.doc.cantEdit)
    },
    scrollTo: Dt(function (e, t) {
      null == e && null == t || Rr(this), null != e && (this.curOp.scrollLeft = e), null != t && (this.curOp.scrollTop = t)
    }),
    ...
    scrollIntoView: Dt(function (e, t) {
      if (null == e ? (e = {
          ...
          from: e,
          to: null
        }), e.to || (e.to = e.from), e.margin = t || 0, null != e.from.line) Rr(this), this.curOp.scrollToPos = e;
      else {
        var r = Ir(this, Math.min(e.from.left, e.to.left), Math.min(e.from.top, e.to.top) - e.margin, Math.max(e.from.right, e.to.right), Math.max(e.from.bottom, e.to.bottom) + e.margin);
    ...
    setSize: Dt(function (e, t) {
      ...
      }), n.curOp.forceUpdate = !0, El(n, "refresh", this)
    }),
    ...
    refresh: Dt(function () {
      ...
      It(this), this.curOp.forceUpdate = !0, at(this), this.scrollTo(this.doc.scrollLeft, this.doc.scrollTop), c(this), (null == e || Math.abs(e - bt(this.display)) > .5) && l(this), El(this, "refresh", this)
    }),
    swapDoc: Dt(function (e) {
      var t = this.doc;
      return t.cm = null, Zn(this, e), at(this), this.display.input.reset(), this.scrollTo(e.scrollLeft, e.scrollTop), this.curOp.forceScroll = !0, Ti(this, "swapDoc", this, t), t
    }),
  ...
  jr("value", "", function (e, t) {
    ...
    n(e), at(e), It(e)
  }, !0), jr("lineSeparator", null, function (e, t) {
    if (e.doc.lineSep = t, t) {
      ...
      e.doc.iter(function (e) {
        for (var i = 0;;) {
          ...
          if (o == -1) break;
          i = o + t.length, r.push(Bo(n, o))
        }
        n++
      });
      for (var i = r.length - 1; i >= 0; i--) Dr(e.doc, t, r[i], Bo(r[i].line, r[i].ch + t.length))
    }
  }), jr("specialChars", /[\u0000-\u001f\u007f\u00ad\u200b-\u200f\u2028\u2029\ufeff]/g, function (t, r, n) {
    t.state.specialChars = new RegExp(r.source + (r.test("\t") ? "" : "|\t"), "g"), n != e.Init && t.refresh()
  }), jr("specialCharPlaceholder", Bn, function (e) {
    e.refresh()
  }, !0), jr("electricChars", !0), jr("inputStyle", Oo ? "contenteditable" : "textarea", function () {
    throw new Error("inputStyle can not (yet) be changed in a running editor")
  }, !0), jr("spellcheck", !1, function (e, t) {
    e.getInputField().spellcheck = t
  }, !0), jr("rtlMoveVisually", !Po), jr("wholeLineUpdateBefore", !0), jr("theme", "default", function (e) {
    s(e), a(e)
    ...
    d(e.options), a(e)
  }, !0), jr("firstLineNumber", 1, a, !0), jr("lineNumberFormatter", function (e) {
    return e
  }, a, !0), jr("showCursorWhenSelecting", !1, Pe, !0), jr("resetSelectionOnContextMenu", !0), jr("lineWiseCopyCut", !0), jr("readOnly", !1, function (e, t) {
    "nocursor" == t ? (yr(e), e.display.input.blur(), e.display.disabled = !0) : e.display.disabled = !1, e.display.input.readOnlyChanged(t)
  }), jr("disableInput", !1, function (e, t) {
    t || e.display.input.reset()
  }, !0), jr("dragDrop", !0, Kt), jr("allowDropFileTypes", null), jr("cursorBlinkRate", 530), jr("cursorScrollMargin", 0), jr("cursorHeight", 1, Pe, !0), jr("singleCursorHeightPerLine", !0, Pe, !0), jr("workTime", 100), jr("workDelay", 100), jr("flattenSpans", !0, n, !0), jr("addModeClass", !1, n, !0), jr("pollInterval", 100), jr("undoDepth", 200, function (e, t) {
  ...
  e.defineMode = function (t, r) {
    e.defaults.mode || "null" == t || (e.defaults.mode = t), arguments.length > 2 && (r.dependencies = Array.prototype.slice.call(arguments, 2)), ol[t] = r
  }, e.defineMIME = function (e, t) {
    ll[e] = t
  }, e.resolveMode = function (t) {
    if ("string" == typeof t && ll.hasOwnProperty(t)) t = ll[t];
    else if (t && "string" == typeof t.name && ll.hasOwnProperty(t.name)) {
      var r = ll[t.name];
      "string" == typeof r && (r = {
        name: r
      }), t = Fi(r, t), t.name = r.name
    } else {
  ...
  e.extendMode = function (e, t) {
    var r = sl.hasOwnProperty(e) ? sl[e] : sl[e] = {};
    Ri(t, r)
  ...
  e.registerHelper = function (t, r, n) {
    ul.hasOwnProperty(t) || (ul[t] = e[t] = {
      _global: []
    }), ul[t][r] = n
  }, e.registerGlobalHelper = function (t, r, n, i) {
    e.registerHelper(t, r, i), ul[t]._global.push({
      pred: n,
      val: i
    })
  };
  var cl = e.copyState = function (e, t) {
      if (t === !0) return t;
    ...
    hl = e.startState = function (e, t, r) {
  ...
  var fl = e.commands = {
      selectAll: function (e) {
        e.setSelection(Bo(e.firstLine(), 0), Bo(e.lastLine()), Rl)
      },
      singleSelection: function (e) {
        e.setSelection(e.getCursor("anchor"), e.getCursor("head"), Rl)
      },
      killLine: function (e) {
        Ur(e, function (t) {
          if (t.empty()) {
            var r = Qn(e.doc, t.head.line).text.length;
      ...
      goLineLeftSmart: function (e) {
        e.extendSelectionsBy(function (t) {
          ...
          return n.ch < e.getLine(n.line).search(/\S/) ? uo(e, t.head) : n
        }, Gl)
      },
      goLineUp: function (e) {
        e.moveV(-1, "line")
        ...
        At(e, function () {
          for (var t = e.listSelections(), r = [], n = 0; n < t.length; n++) {
            ...
            if (o)
              ...
              var l = Qn(e.doc, i.line - 1).text;
              l && e.replaceRange(o.charAt(0) + e.doc.lineSeparator() + l.charAt(l.length - 1), Bo(i.line - 1, l.length - 1), Bo(i.line, 1), "+transpose")
            }
            r.push(new he(i, i))
          }
          e.setSelections(r)
  ...
  }, dl.default = Do ? dl.macDefault : dl.pcDefault, e.normalizeKeyMap = function (e) {
    var t = {};
    for (var r in e)
      if (e.hasOwnProperty(r)) {
        ...
        for (var i = Ei(r.split(" "), Xr), o = 0; o < i.length; o++) {
          var l, s;
  ...
  var pl = e.lookupKey = function (e, t, r, n) {
      t = Yr(t);
      ...
      if (t.fallthrough) {
        if ("[object Array]" != Object.prototype.toString.call(t.fallthrough)) return pl(e, t.fallthrough, r, n);
        for (var o = 0; o < t.fallthrough.length; o++) {
          var l = pl(e, t.fallthrough[o], r, n);
          if (l) return l
        }
      }
    },
    gl = e.isModifierKey = function (e) {
      var t = "string" == typeof e ? e : ss[e.keyCode];
      return "Ctrl" == t || "Alt" == t || "Shift" == t || "Mod" == t
    },
    vl = e.keyName = function (e, t) {
      if (ko && 34 == e.keyCode && e.char) return !1;
      var r = ss[e.keyCode],
        n = r;
      return null != n && !e.altGraphKey && (e.altKey && "Alt" != r && (n = "Alt-" + n), (Io ? e.metaKey : e.ctrlKey) && "Ctrl" != r && (n = "Ctrl-" + n), (Io ? e.ctrlKey : e.metaKey) && "Cmd" != r && (n = "Cmd-" + n), !t && e.shiftKey && "Shift" != r && (n = "Shift-" + n), n)
    };
  e.fromTextArea = function (t, r) {
    function n() {
      t.value = a.getValue()
    }
    if (r = r ? Ri(r) : {}, r.value = t.value, !r.tabindex && t.tabIndex && (r.tabindex = t.tabIndex), !r.placeholder && t.placeholder && (r.placeholder = t.placeholder), null == r.autofocus) {
      var i = Yi();
      r.autofocus = i == t || null != t.getAttribute("autofocus") && i == document.body
    }
    if (t.form && (Dl(t.form, "submit", n), !r.leaveSubmitMethodAlone)) {
      var o = t.form,
        l = o.submit;
      try {
    ...
    r.finishInit = function (e) {
      e.save = n, e.getTextArea = function () {
        ...
        e.toTextArea = isNaN, n(), t.parentNode.removeChild(e.getWrapperElement()), t.style.display = "", t.form && (Pl(t.form, "submit", n), "function" == typeof t.form.submit && (t.form.submit = l))
      }
  ...
  var ml = e.StringStream = function (e, t) {
  ...
  ml.prototype = {
    ...
    column: function () {
      return this.lastColumnPos < this.start && (this.lastColumnValue = Ul(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue), this.lastColumnPos = this.start), this.lastColumnValue - (this.lineStart ? Ul(this.string, this.lineStart, this.tabSize) : 0)
    },
    indentation: function () {
      return Ul(this.string, null, this.tabSize) - (this.lineStart ? Ul(this.string, this.lineStart, this.tabSize) : 0)
    },
  ...
  var yl = 0,
    bl = e.TextMarker = function (e, t) {
      this.lines = [], this.type = t, this.doc = e, this.id = ++yl
    };
  Ai(bl), bl.prototype.clear = function () {
    if (!this.explicitlyCleared) {
      var e = this.doc.cm,
        t = e && !e.curOp;
      if (t && xt(e), Wi(this, "clear")) {
        var r = this.find();
        r && Ti(this, "clear", r.from, r.to)
      }
      for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
        var l = this.lines[o],
          s = en(l.markedSpans, this);
        e && !this.collapsed ? zt(e, ri(l), "text") : e && (null != s.to && (i = ri(l)), null != s.from && (n = ri(l))), l.markedSpans = tn(l.markedSpans, s), null == s.from && this.collapsed && !Sn(this.doc, l) && e && ti(l, bt(e.display))
      }
      if (e && this.collapsed && !e.options.lineWrapping)
        for (var o = 0; o < this.lines.length; ++o) {
          var a = bn(this.lines[o]),
            u = h(a);
          u > e.display.maxLineLength && (e.display.maxLine = a, e.display.maxLineLength = u, e.display.maxLineChanged = !0)
        }
      null != n && e && this.collapsed && It(e, n, i + 1), this.lines.length = 0, this.explicitlyCleared = !0, this.atomic && this.doc.cantEdit && (this.doc.cantEdit = !1, e && We(e.doc)), e && Ti(e, "markerCleared", e, this), t && St(e), this.parent && this.parent.clear()
    }
  }, bl.prototype.find = function (e, t) {
    null == e && "bookmark" == this.type && (e = 1);
    for (var r, n, i = 0; i < this.lines.length; ++i) {
      var o = this.lines[i],
        l = en(o.markedSpans, this);
      if (null != l.from && (r = Bo(t ? o : ri(o), l.from), e == -1)) return r;
      if (null != l.to && (n = Bo(t ? o : ri(o), l.to), 1 == e)) return n
    }
    return r && {
      from: r,
      to: n
    ...
    e && r && At(r, function () {
      var n = e.line,
        i = ri(e.line),
        o = Je(r, i);
      if (o && (lt(o), r.curOp.selectionChanged = r.curOp.forceUpdate = !0), r.curOp.updateMaxLine = !0, !Sn(t.doc, n) && null != t.height) {
        var l = t.height;
        t.height = null;
        var s = kn(t) - l;
        s && ti(n, n.height + s)
  ...
  }, bl.prototype.attachLine = function (e) {
    if (!this.lines.length && this.doc.cm) {
      var t = this.doc.cm.curOp;
      t.maybeHiddenMarkers && Pi(t.maybeHiddenMarkers, this) != -1 || (t.maybeUnhiddenMarkers || (t.maybeUnhiddenMarkers = [])).push(this)
    }
    this.lines.push(e)
  }, bl.prototype.detachLine = function (e) {
  ...
  var yl = 0,
    wl = e.SharedTextMarker = function (e, t) {
      this.markers = e, this.primary = t;
      for (var r = 0; r < e.length; ++r) e[r].parent = this
    };
  Ai(wl), wl.prototype.clear = function () {
    if (!this.explicitlyCleared) {
  ...
  var xl = e.LineWidget = function (e, t, r) {
    if (r)
      for (var n in r) r.hasOwnProperty(n) && (this[n] = r[n]);
    this.doc = e, this.node = t
  };
  Ai(xl), xl.prototype.clear = function () {
    var e = this.doc.cm,
      t = this.line.widgets,
      r = this.line,
      n = ri(r);
    if (null != n && t) {
      ...
      var o = kn(this);
      ti(r, Math.max(0, r.height - o)), e && At(e, function () {
        Tn(e, r, -o), zt(e, n, "widget")
      })
    }
    ...
    this.height = null;
    var n = kn(this) - e;
    n && (ti(r, r.height + n), t && At(t, function () {
      t.curOp.forceUpdate = !0, Tn(t, r, n)
    }))
  };
  var Cl = e.Line = function (e, t, r) {
    this.text = e, hn(this, t), this.height = r ? r(this) : 1
  };
  Ai(Cl), Cl.prototype.lineNo = function () {
    return ri(this)
  };
  var Sl = {},
    Ll = {};
  _n.prototype = {
    ...
    removeInner: function (e, t) {
      for (var r = e, n = e + t; r < n; ++r) {
        var i = this.lines[r];
        this.height -= i.height, Wn(i), Ti(i, "delete")
      }
    ...
    removeInner: function (e, t) {
      ...
      if (this.size - t < 25 && (this.children.length > 1 || !(this.children[0] instanceof _n))) {
        var s = [];
        this.collapse(s), this.children = [new _n(s)], this.children[0].parent = this
      }
    },
    collapse: function (e) {
        ...
        if (e <= o) {
          if (i.insertInner(e, t, r), i.lines && i.lines.length > 50) {
            for (var l = i.lines.length % 25 + 25, s = l; s < i.lines.length;) {
              var a = new _n(i.lines.slice(s, s += 25));
  ...
  var Tl = 0,
    kl = e.Doc = function (e, t, r, n) {
      if (!(this instanceof kl)) return new kl(e, t, r, n);
      ...
      var i = Bo(r, 0);
      this.sel = de(i), this.history = new li(null), this.id = ++Tl, this.modeOption = t, this.lineSep = n, this.extend = !1, "string" == typeof e && (e = this.splitLines(e)), Yn(this, {
        from: i,
        to: i,
        text: e
      }), ke(this, de(i), Rl)
    };
  kl.prototype = Fi(qn.prototype, {
    constructor: kl,
    iter: function (e, t, r) {
    ...
    getValue: function (e) {
      var t = ei(this, this.first, this.first + this.size);
    ...
    replaceRange: function (e, t, r, n) {
      t = ge(this, t), r = r ? ge(this, r) : t, Dr(this, e, t, r, n)
    },
    getRange: function (e, t, r) {
      var n = Jn(this, ge(this, e), ge(this, t));
    ...
    getLineHandle: function (e) {
      if (me(this, e)) return Qn(this, e)
    },
    getLineNumber: function (e) {
      return ri(e)
    },
    getLineHandleVisualStart: function (e) {
      return "number" == typeof e && (e = Qn(this, e)), bn(e)
    },
    lineCount: function () {
      return this.size
    },
    ...
    setCursor: Ht(function (e, t, r) {
      Se(this, ge(this, "number" == typeof e ? Bo(e, t || 0) : e), null, r)
    }),
    ...
    replaceSelections: Ht(function (e, t, r) {
      ...
      for (var s = t && "end" != t && Lr(this, n, t), o = n.length - 1; o >= 0; o--) kr(this, n[o]);
      s ? Te(this, s) : this.cm && Fr(this.cm)
    }),
    undo: Ht(function () {
      Nr(this, "undo")
    }),
    ...
    addLineClass: Ht(function (e, t, r) {
      return Gr(this, e, "gutter" == t ? "gutter" : "class", function (e) {
        var n = "text" == t ? "textClass" : "background" == t ? "bgClass" : "gutter" == t ? "gutterClass" : "wrapClass";
        if (e[n]) {
          if (_i(r).test(e[n])) return !1;
          e[n] += " " + r
        } else e[n] = r;
        return !0
      })
    ...
    copy: function (e) {
      var t = new kl(ei(this, this.first, this.first + this.size), this.modeOption, this.first, this.lineSep);
    ...
    unlinkDoc: function (t) {
      if (t instanceof e && (t = t.doc), this.linked)
        for (var r = 0; r < this.linked.length; ++r) {
          var n = this.linked[r];
          if (n.doc == t) {
            this.linked.splice(r, 1), t.unlinkDoc(this), Qr($r(this));
            break
          }
        }
      if (t.history == this.history) {
        ...
        $n(t, function (e) {
          i.push(e.id)
        }, !0), t.history = new li(null), t.history.done = mi(this.history.done, i), t.history.undone = mi(this.history.undone, i)
      }
    },
    ...
    splitLines: function (e) {
      return this.lineSep ? e.split(this.lineSep) : ns(e)
    },
    lineSeparator: function () {
      return this.lineSep || "\n"
    }
  }), kl.prototype.eachLine = kl.prototype.iter;
  var Ml = "iter insert remove copy getEditor constructor".split(" ");
  for (var Nl in kl.prototype) kl.prototype.hasOwnProperty(Nl) && Pi(Ml, Nl) < 0 && (e.prototype[Nl] = function (e) {
    return function () {
      return e.apply(this.doc, arguments)
    }
  }(kl.prototype[Nl]));
  Ai(kl);
  var Wl = e.e_preventDefault = function (e) {
      e.preventDefault ? e.preventDefault() : e.returnValue = !1
    },
    Al = e.e_stopPropagation = function (e) {
      e.stopPropagation ? e.stopPropagation() : e.cancelBubble = !0
    },
    Ol = e.e_stop = function (e) {
      Wl(e), Al(e)
    },
    Dl = e.on = function (e, t, r) {
    ...
    Hl = [],
    Pl = e.off = function (e, t, r) {
      if (e.removeEventListener) e.removeEventListener(t, r, !1);
      else if (e.detachEvent) e.detachEvent("on" + t, r);
      else
        for (var n = Li(e, t, !1), i = 0; i < n.length; ++i)
          if (n[i] == r) {
            n.splice(i, 1);
            break
          }
    },
    El = e.signal = function (e, t) {
      var r = Li(e, t, !0);
      if (r.length)
  ...
  var Ul = e.countColumn = function (e, t, r, n, i) {
    ...
    Vl = e.findColumn = function (e, t, r) {
      for (var n = 0, i = 0;;) {
        var o = e.indexOf("\t", n);
        o == -1 && (o = e.length);
        var l = o - n;
  ...
  var Xl, Yl = /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/,
    _l = e.isWordChar = function (e) {
      return /\w/.test(e) || e > "" && (e.toUpperCase() != e.toLowerCase() || Yl.test(e))
    },
  ...
  Xl = document.createRange ? function (e, t, r, n) {
  ...
  var Zl, Ql, Jl = e.rmClass = function (e, t) {
      var r = e.className,
        n = _i(t).exec(r);
      if (n) {
  ...
  var as, us = function () {
    ...
    return function (r) {
      ...
      for (var n, c = r.length, h = [], f = 0; f < c; ++f) h.push(n = e(r.charCodeAt(f)));
      for (var f = 0, d = u; f < c; ++f) {
        var n = h[f];
        "m" == n ? h[f] = d : d = n
      }
      ...
      for (var f = 0; f < c; ++f) {
        ...
        if ("," == n) h[f] = "N";
          ...
          for (var g = f + 1; g < c && "%" == h[g]; ++g);
          for (var v = f && "!" == h[f - 1] || g < c && "1" == h[g] ? "1" : "N", m = f; m < g; ++m) h[m] = v;
          f = g - 1
        }
      }
      for (var f = 0, p = u; f < c; ++f) {
      ...
      for (var f = 0; f < c; ++f)
        if (o.test(h[f])) {
          for (var g = f + 1; g < c && o.test(h[g]); ++g);
          for (var y = "L" == (f ? h[f - 1] : u), b = "L" == (g < c ? h[g] : u), v = y || b ? "L" : "R", m = f; m < g; ++m) h[m] = v;
          f = g - 1
        } for (var w, x = [], f = 0; f < c;)
        if (s.test(h[f])) {
          var C = f;
          for (++f; f < c && s.test(h[f]); ++f);
          x.push(new t(0, C, f))
        } else {
          var S = f,
            L = x.length;
          ...
          for (var m = S; m < f;)
            if (a.test(h[m])) {
              S < m && x.splice(L, 0, new t(1, S, m));
              var T = m;
              for (++m; m < f && a.test(h[m]); ++m);
              x.splice(L, 0, new t(2, T, m)), S = m
            } else ++m;
          S < f && x.splice(L, 0, new t(1, S, f))
        } return 1 == x[0].level && (w = r.match(/^\s+/)) && (x[0].from = w[0].length, x.unshift(new t(0, 0, w[0].length))), 1 == Hi(x).level && (w = r.match(/\s+$/)) && (Hi(x).to -= w[0].length, x.push(new t(0, c - w[0].length, c))), 2 == x[0].level && x.unshift(new t(1, x[0].to, x[0].to)), x[0].level != Hi(x).level && x.push(new t(x[0].level, c, c)), x
    }
  }();
  return e.version = "5.19.0", e
});